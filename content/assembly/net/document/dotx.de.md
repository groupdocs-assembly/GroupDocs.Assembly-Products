...
draft: false
path: "de/assembly/net/document/dotx/"
...
############################# Head ############################
head_title: "Fügen Sie den Inhalt des äußeren Dokuments über die .NET-API in E-Mails und DOTX-Datei ein"
...
steps:
    ...
    - title_left: "Fügen Sie den Inhalt des äußeren Dokuments über .NET in eine Word-Datei ein"
      ...
      title_right: "So fügen Sie den Inhalt des Dokuments der Datei DOTX hinzu"
      content_right: |
