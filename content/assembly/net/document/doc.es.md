...
draft: false
path: "es/assembly/net/document/doc/"
...
############################# Head ############################
head_title: "Inserte el contenido del documento externo en los correos electrónicos y el archivo DOC a través de la API de .NET"
...
steps:
    ...
    - title_left: "Inserte el contenido del documento externo en un archivo de Word a través de .NET"
      ...
      title_right: "Cómo agregar el contenido del documento al archivo DOC"
      content_right: |
