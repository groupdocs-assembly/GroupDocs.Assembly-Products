...
draft: false
path: "assembly/net/document/xlsm"
...
############################# Head ############################
head_title: "Insert Outer Document's Content to Emails & XLSM File via .NET API"
...
steps:
    ...
    - title_left: "Insert Outer Document Contents to Word File via .NET"
      ...
      title_right: "How to Add Document's Content to XLSM File"
      content_right: |
