...
draft: false
path: "fr/assembly/net/document/ppt/"
...
############################# Head ############################
head_title: "Insérer le contenu du document externe dans les e-mails et le fichier PPT via l'API .NET"
...
steps:
    ...
    - title_left: "Insérer le contenu du document externe dans un fichier Word via .NET"
      ...
      title_right: "Comment ajouter le contenu du document au fichier PPT"
      content_right: |
