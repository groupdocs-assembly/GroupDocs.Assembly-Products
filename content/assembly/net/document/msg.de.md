...
draft: false
path: "de/assembly/net/document/msg/"
...
############################# Head ############################
head_title: "Fügen Sie den Inhalt des äußeren Dokuments über die .NET-API in E-Mails und MSG-Datei ein"
...
steps:
    ...
    - title_left: "Fügen Sie den Inhalt des äußeren Dokuments über .NET in eine Word-Datei ein"
      ...
      title_right: "So fügen Sie den Inhalt des Dokuments der Datei MSG hinzu"
      content_right: |
