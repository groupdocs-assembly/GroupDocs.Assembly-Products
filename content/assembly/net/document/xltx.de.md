...
draft: false
path: "de/assembly/net/document/xltx/"
...
############################# Head ############################
head_title: "Fügen Sie den Inhalt des äußeren Dokuments über die .NET-API in E-Mails und XLTX-Datei ein"
...
steps:
    ...
    - title_left: "Fügen Sie den Inhalt des äußeren Dokuments über .NET in eine Word-Datei ein"
      ...
      title_right: "So fügen Sie den Inhalt des Dokuments der Datei XLTX hinzu"
      content_right: |
