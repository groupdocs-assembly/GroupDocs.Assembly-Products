...
draft: false
path: "fr/assembly/net/document/emlx/"
...
############################# Head ############################
head_title: "Insérer le contenu du document externe dans les e-mails et le fichier EMLX via l'API .NET"
...
steps:
    ...
    - title_left: "Insérer le contenu du document externe dans un fichier Word via .NET"
      ...
      title_right: "Comment ajouter le contenu du document au fichier EMLX"
      content_right: |
