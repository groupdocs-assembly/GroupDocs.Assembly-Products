...
draft: false
path: "de/assembly/net/document/docx/"
...
############################# Head ############################
head_title: "Fügen Sie den Inhalt des äußeren Dokuments über die .NET-API in E-Mails und DOCX-Datei ein"
...
steps:
    ...
    - title_left: "Fügen Sie den Inhalt des äußeren Dokuments über .NET in eine Word-Datei ein"
      ...
      title_right: "So fügen Sie den Inhalt des Dokuments der Datei DOCX hinzu"
      content_right: |
