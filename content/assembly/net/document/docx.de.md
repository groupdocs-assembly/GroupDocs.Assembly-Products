...
############################# Head ############################
head_title: "Ein Dokument in ein anderes im DOCX mit C# API einbetten"
head_description: "Fügen Sie mühelos DOCX-Dokumente mit C# zusammen. Mit GroupDocs.Assembly kombinieren Sie Dateien nahtlos in nur wenigen Schritten."

############################# Header ############################
title: "Dokumente im DOCX-Format kombinieren" 
description: "Mit GroupDocs.Assembly for .NET können Sie schnell ein DOCX-Dokument in ein anderes einbetten. Diese API bietet leistungsstarke Werkzeuge für präzises Dokumenten-Merging."
...
steps:
    enable: true
    title: "Wie man ein Dokument in eine DOCX-Datei einfügt"
    content: |
      [GroupDocs.Assembly](/assembly/net/) ermöglicht es, ein Dokument mühelos in eine andere DOCX-Datei einzubetten. Inhalte zusammenführen und anpassen.
      
      1. Entwerfen Sie eine DOCX-Vorlage mit Platzhaltern für das einzubettende Dokument.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Wie man ein Bild programmgesteuert in ein Dokument einfügt"
      content: |
        Dieses Beispiel zeigt, wie man ein Bild in ein DOCX-Dokument mit GroupDocs.Assembly einfügt.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
