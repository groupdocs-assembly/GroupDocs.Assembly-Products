...
draft: false
path: "assembly/net/document/epub"
...
############################# Head ############################
head_title: "Insert Outer Document's Content to Emails & EPUB File via .NET API"
...
steps:
    ...
    - title_left: "Insert Outer Document Contents to Word File via .NET"
      ...
      title_right: "How to Add Document's Content to EPUB File"
      content_right: |
