...
draft: false
path: "de/assembly/net/document/tiff/"
...
############################# Head ############################
head_title: "Fügen Sie den Inhalt des äußeren Dokuments über die .NET-API in E-Mails und TIFF-Datei ein"
...
steps:
    ...
    - title_left: "Fügen Sie den Inhalt des äußeren Dokuments über .NET in eine Word-Datei ein"
      ...
      title_right: "So fügen Sie den Inhalt des Dokuments der Datei TIFF hinzu"
      content_right: |
