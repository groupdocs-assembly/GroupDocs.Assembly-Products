...
############################# Head ############################
head_title: "Incorpora un documento in un altro in XLSX con l'API C#"
head_description: "Unisci documenti XLSX utilizzando C#. Con GroupDocs.Assembly, combina file senza soluzione di continuità in pochi passaggi."

############################# Header ############################
title: "Combina documenti nel formato XLSX" 
description: "Con GroupDocs.Assembly for .NET, puoi rapidamente incorporare un documento XLSX in un altro. Questa API offre strumenti robusti per unire documenti con precisione."
...
steps:
    ...
    content: |
      [GroupDocs.Assembly](/assembly/net/) ti consente di incorporare un documento in un altro file XLSX senza sforzo. Unisci e personalizza i contenuti.
      
      1. Progetta un modello XLSX con segnaposto per il documento incorporato.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Come incorporare un'immagine in un documento programmaticamente"
      content: |
        Questo esempio dimostra come inserire un'immagine in un documento XLSX utilizzando GroupDocs.Assembly.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
