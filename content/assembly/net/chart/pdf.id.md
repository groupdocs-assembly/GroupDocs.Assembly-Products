...
############################# Head ############################
head_title: "Buat grafik dalam file PDF dengan C#"
...
############################# Header ############################
title: "Sisipkan grafik dalam file PDF dengan API .NET" 
description: "GroupDocs.Assembly for .NET memberikan cara yang ampuh untuk mengisi file PDF dengan data dinamis dan mengintegrasikan grafik dengan lancar."
...
steps:
    enable: true
    title: "Cara menambahkan grafik ke dokumen PDF"
    content: |
      [GroupDocs.Assembly](/assembly/net/) memudahkan untuk menghasilkan dan menyisipkan grafik ke dalam templat PDF Anda. Mendukung berbagai jenis grafik, seperti grafik batang, lingkaran, dan garis.
      
      1. Rancang templat dengan tempat yang ditentukan untuk grafik (templat PDF tidak didukung).
      2. Ambil data Anda dari sumber yang kompatibel.
      3. Tentukan opsi grafik seperti tipe, label, dan skema warna.
      4. Ekspor dokumen dengan grafik sebagai file PDF.
    ...
    code:
      ...
      content: |
        ...
        // Saat ini, templat PDF tidak didukung.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Buat grafik secara programatis"
      content: |
        Contoh ini menunjukkan cara membuat dan menyisipkan grafik secara dinamis ke dalam dokumen PDF.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
