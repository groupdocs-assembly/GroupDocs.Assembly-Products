...
############################# Head ############################
head_title: "Diagramme in XLSX-Dateien mit C# erstellen"
...
############################# Header ############################
title: "Diagramme in XLSX-Dateien mit .NET API einbetten" 
description: "GroupDocs.Assembly for .NET bietet eine leistungsstarke Möglichkeit, XLSX-Dateien mit dynamischen Daten zu füllen und Diagramme mühelos zu integrieren."
...
steps:
    enable: true
    title: "Wie man ein Diagramm in ein XLSX-Dokument einfügt"
    content: |
      [GroupDocs.Assembly](/assembly/net/) erleichtert das Erzeugen und Einbetten von Diagrammen in deine XLSX-Vorlagen. Unterstützt eine Vielzahl von Diagrammtypen, wie Balken-, Kreis- und Liniendiagramme.
      
      1. Entwirf eine XLSX-Vorlage mit Platzhaltern für die Diagramme.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Ein Diagramm programmgesteuert erstellen"
      content: |
        Dieses Beispiel zeigt, wie man dynamisch ein Diagramm in ein XLSX-Dokument erstellt und einfügt.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
