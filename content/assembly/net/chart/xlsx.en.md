...
############################# Head ############################
head_title: "Create charts in XLSX files with C#"
...
############################# Header ############################
title: "Embed charts in XLSX files with .NET API" 
description: "GroupDocs.Assembly for .NET provides a powerful way to populate XLSX files with dynamic data and integrate charts effortlessly."
...
steps:
    enable: true
    title: "How to add a chart to a XLSX document"
    content: |
      [GroupDocs.Assembly](/assembly/net/) makes it simple to generate and embed charts into your XLSX templates. Supports a variety of chart types, such as bar, pie, and line charts.
