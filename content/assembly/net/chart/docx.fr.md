...
############################# Head ############################
head_title: "Créez des graphiques dans des fichiers DOCX avec C#"
...
############################# Header ############################
title: "Intégrez des graphiques dans des fichiers DOCX avec l'API .NET" 
description: "GroupDocs.Assembly for .NET offre un moyen puissant de remplir des fichiers DOCX avec des données dynamiques et d'intégrer des graphiques sans effort."
...
steps:
    enable: true
    title: "Comment ajouter un graphique à un document DOCX"
    content: |
      [GroupDocs.Assembly](/assembly/net/) facilite la génération et l'intégration de graphiques dans vos modèles DOCX. Prend en charge une variété de types de graphiques, tels que des graphiques à barres, circulaires et linéaires.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Créer un graphique par programme"
      content: |
        Cet exemple démontre comment créer et intégrer dynamiquement un graphique dans un document DOCX.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
