...
draft: false
path: "de/assembly/net/barcode/ods/"
...
############################# Header ############################
title: "Erstellung und Verwaltung von Barcodes in ODS Spreadsheet über .NET API"
description: "Mithilfe von GroupDocs.Assembly .NET API können Softwareentwickler Barcode-Bilder in Excel ODS Spreadsheet-Dokumenten in C#- und ASP.NET-Apps dynamisch erstellen und verwalten."
...
steps:
    enable: true
    block:
    - title_left: "Barcode-Generierung in ODS Spreadsheets über .NET"
      content_left: |
       GroupDocs.Assembly .NET bietet vollständige Unterstützung für das Hinzufügen und Verwalten von Barcodes in der Tabelle ODS. Das folgende C# .NET-Codebeispiel zeigt, wie Barcodebilder generiert und in ein Microsoft Excel-Tabellendokument eingefügt werden. 

      title_right: "So verwenden Sie Barcode-Bilder in ODS"
      content_right: |
