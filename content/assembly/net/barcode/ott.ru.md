...
############################# Header ############################
title: "Создание и использование изображений штрих-кода в документах Word OTT через .NET"
description: "Используя GroupDocs.Assembly .NET API, программисты могут динамически создавать и управлять изображениями штрих-кода в документах Word OTT в C#, ASP.NET и других приложениях .NET."
...
steps:
    enable: true
    block:
    - title_left: "Как создавать штрих-коды в документах OTT"
      content_left: |
       В следующем примере кода .NET показано, как легко пользователи могут динамически создавать и добавлять изображения штрих-кода в свои собственные документы Microsoft Word OTT, написав всего пару строк кода.  

      title_right: "Используйте изображения штрих-кода в файле OTT через .NET"
      content_right: |
