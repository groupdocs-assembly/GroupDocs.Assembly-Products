...
draft: false
path: "assembly/net/barcode/odp"
otherformats: PPT PPTX PPTM PPS PPSX PPSM POT POTX POTM OTP 

head_title: "..NET API untuk Pembuatan Gambar Kode Batang dalam Presentasi ODP"
...
title: "Buat & Kelola gambar Barcode di ODP Presentations melalui .NET API"
description: " GroupDocs.Assembly memungkinkan pemrogram .NET untuk membuat, memodifikasi & mengelola gambar Barcode secara dinamis di ODP Presentations di dalam C#, ASP.NET & aplikasi .NET lainnya."
...
steps:
    enable: true
    block:
    - title_left: "Tambahkan Barcode di dalam ODP Presentations"
      content_left: |
       Kode C# .NET di bawah ini menunjukkan bagaimana pengguna dapat secara dinamis membuat gambar Barcode menggunakan simbologi yang didukung berbeda dan memasukkannya ke dalam slide presentasi Microsoft PowerPoint ODP.
      
      title_right: "Masukkan Barcode dalam File ODP melalui .NET"
      content_right: |
