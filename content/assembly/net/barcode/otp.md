...
############################# Head ############################
head_title: ".NET API for Barcode Images Creation in OTP Presentations"
...
############################# Header ############################
title: "Create & Manage Barcode images in OTP Presentations via .NET API"
description: " GroupDocs.Assembly allows .NET programmers to dynamically create, modify &  manage Barcode images in OTP Presentations inside C#, ASP.NET & other .NET apps."
...
steps:
    enable: true
    block:
    - title_left: "Add Barcodes inside OTP Presentations"
      content_left: |
       The below C# .NET code shows how users can dynamically create Barcode images using different supported symbologies and insert them inside a Microsoft PowerPoint OTP presentation slides.
      
      title_right: "Insert Barcodes in OTP File via .NET"
      content_right: |
