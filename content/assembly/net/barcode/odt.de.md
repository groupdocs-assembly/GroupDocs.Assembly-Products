...
draft: false
path: "de/assembly/net/barcode/odt/"
...
############################# Header ############################
title: "Erstellen und verwenden Sie Barcode-Bilder in Word ODT-Dokumenten über .NET"
description: "Mithilfe von GroupDocs.Assembly können .NET-API-Programmierer Barcode-Bilder in Word ODT Dokumenten innerhalb von C#, ASP.NET und anderen .NET-Apps dynamisch erstellen und verwalten."
...
steps:
    enable: true
    block:
    - title_left: "So erstellen Sie Strichcodes in ODT Dokumenten"
      content_left: |
       Das folgende .NET-Codebeispiel zeigt, wie einfach Benutzer mit nur wenigen Codezeilen Barcode-Bilder dynamisch generieren und in ihre eigenen Microsoft Word ODT Dokumente einfügen können. 

      title_right: "Verwenden Sie Barcode-Bilder in der ODT Datei über .NET"
      content_right: |
