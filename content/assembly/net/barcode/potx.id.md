...
head_title: "..NET API untuk Pembuatan Gambar Kode Batang dalam Presentasi POTX"
...
title: "Buat & Kelola gambar Barcode di POTX Presentations melalui .NET API"
description: " GroupDocs.Assembly memungkinkan pemrogram .NET untuk membuat, memodifikasi & mengelola gambar Barcode secara dinamis di POTX Presentations di dalam C#, ASP.NET & aplikasi .NET lainnya."
...
steps:
    enable: true
    block:
    - title_left: "Tambahkan Barcode di dalam POTX Presentations"
      content_left: |
       Kode C# .NET di bawah ini menunjukkan bagaimana pengguna dapat secara dinamis membuat gambar Barcode menggunakan simbologi yang didukung berbeda dan memasukkannya ke dalam slide presentasi Microsoft PowerPoint POTX.
      
      title_right: "Masukkan Barcode dalam File POTX melalui .NET"
      content_right: |
