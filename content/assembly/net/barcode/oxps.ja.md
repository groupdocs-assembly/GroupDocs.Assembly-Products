...
draft: false
path: "ja/assembly/net/barcode/oxps/"
otherformats: PDF HTML XPS TIFF MHTML TXT XAML EPUB SVG PS PCL XML MD EML EMLX MSG 

############################# Head ############################
head_title: ".NETを介してOXPS ドキュメントと電子メールでバーコード画像を作成および追加する"
...
############################# Header ############################
title: ".NETAPIを介してOXPS ドキュメントにバーコード画像を生成して挿入する"
description: "GroupDocs.Assembly .NETは、C＃およびVB.NET APIを使用して、動的なバーコードイメージの作成、編集、およびOXPSドキュメント内での追加を完全にサポートします。"
...
about:
    enable: true
    title: "OXPSドキュメントでバーコード画像の生成を実行する方法は？"
    content: |
...
steps:
    enable: true
    block:
    - title_left: ".NETを介したOXPS ドキュメントでのバーコードの生成"
      content_left: |
       GroupDocs.Assembly .NETは、OXPS ドキュメント内のバーコードの追加と管理を完全にサポートします。 次のC＃.NETコード例は、OXPSドキュメント内にバーコードイメージを生成して挿入する方法を示しています。 

      title_right: "OXPS でバーコード画像を使用する方法"
      content_right: |
...
layout: "auto-gen-gist"
draft: false
path: "assembly/net/barcode/oxps"
otherformats: PDF HTML XPS TIFF MHTML TXT XAML EPUB SVG PS PCL XML MD EML EMLX MSG 
...
title: ".NETAPIを介したOXPSドキュメントでのバーコード画像の生成と挿入"
description: "GroupDocs.Assembly .NETは、C＃およびVB.NET APIを使用して、動的なバーコードイメージの作成、編集、およびOXPSドキュメント内での追加を完全にサポートします。"
...
steps:
    enable: true
    block:
    - title_left: ".NETを介したOXPSドキュメントでのバーコードの生成"
      content_left: |
       GroupDocs.Assembly .NETは、OXPSドキュメント内のバーコードの追加と管理を完全にサポートします。次のC＃.NETコード例は、OXPSドキュメント内にバーコード画像を生成して挿入する方法を示しています。 

      title_right: "OXPSでバーコード画像を使用する方法"
      content_right: |
        * [DocumentAssembler](https://apireference.groupdocs.com/assembly/net/groupdocs.assembly/documentassembler)のインスタンスを作成します 
...
<<<<<<< HEAD
    - title_left: ".NET経由でOXPS にバーコード画像の解像度を設定"
      content_left: |
       GroupDocs.Assembly .NETは、OXPS ドキュメント内のバーコードの追加と管理を完全にサポートします。 数行のコードで簡単にバーコード解像度を設定できます。 次のコードを使用すると、ユーザーは水平および垂直の解像度を300DPIに設定できます。

      title_right: "OXPS の強化されたバーコード解像度"
      content_right: |
        * [DocumentAssembler](https://apireference.groupdocs.com/assembly/net/groupdocs.assembly/documentassembler) のインスタンスを作成します 
=======
    - title_left: ".NETを介してOXPSでバーコード画像の解像度を設定する"
      content_left: |
       GroupDocs.Assembly .NETは、OXPSドキュメント内のバーコードの追加と管理を完全にサポートします。数行のコードでバーコードの解像度を簡単に設定できます。次のコードを使用すると、ユーザーは水平および垂直の解像度を300DPIに設定できます。 

      title_right: "OXPSでの強化されたバーコード解像度"
      content_right: |
        * [DocumentAssembler](https://apireference.groupdocs.com/assembly/net/groupdocs.assembly/documentassembler)のインスタンスを作成します 
>>>>>>> a412dc18b5488251d42f98ec3007ac8bde559922
