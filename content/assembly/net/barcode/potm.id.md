...
head_title: ".NET API untuk Pembuatan Gambar Kode Batang dalam Presentasi POTM"
...
title: "Buat & Kelola gambar Barcode di POTM Presentations melalui .NET API"
description: " GroupDocs.Assembly memungkinkan pemrogram .NET untuk membuat, memodifikasi & mengelola gambar Barcode secara dinamis di POTM Presentations di dalam C#, ASP.NET & aplikasi .NET lainnya."
...
steps:
    enable: true
    block:
    - title_left: "Tambahkan Barcode di dalam POTM Presentations"
      content_left: |
       Kode C# .NET di bawah ini menunjukkan bagaimana pengguna dapat secara dinamis membuat gambar Barcode menggunakan simbologi yang didukung berbeda dan memasukkannya ke dalam slide presentasi Microsoft PowerPoint POTM.
      
      title_right: "Masukkan Barcode dalam File POTM melalui .NET"
      content_right: |
