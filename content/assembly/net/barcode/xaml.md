...
steps:
    enable: true
    block:
    - title_left: "Barcodes Generation in XAML Documents via .NET"
      content_left: |
       GroupDocs.Assembly .NET provides complete support for adding and managing Barcodes inside XAML documents. The following C# .NET code example demonstrates how to generate and insert barcode images inside a XAML document. 

      title_right: "How to Use Barcode Images in XAML"
      content_right: |
