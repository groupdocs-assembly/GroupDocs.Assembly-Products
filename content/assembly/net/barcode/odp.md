...
############################# Head ############################
head_title: ".NET API for Barcode Images Creation in ODP Presentations"
...
############################# Header ############################
title: "Create & Manage Barcode images in ODP Presentations via .NET API"
description: " GroupDocs.Assembly allows .NET programmers to dynamically create, modify &  manage Barcode images in ODP Presentations inside C#, ASP.NET & other .NET apps."
...
steps:
    enable: true
    block:
    - title_left: "Add Barcodes inside ODP Presentations"
      content_left: |
       The below C# .NET code shows how users can dynamically create Barcode images using different supported symbologies and insert them inside a Microsoft PowerPoint ODP presentation slides.
      
      title_right: "Insert Barcodes in ODP File via .NET"
      content_right: |
