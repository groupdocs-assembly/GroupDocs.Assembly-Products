...
############################# Head ############################
head_title: ".NET API for Barcode Images Creation in POTX Presentations"
...
############################# Header ############################
title: "Create & Manage Barcode images in POTX Presentations via .NET API"
description: " GroupDocs.Assembly allows .NET programmers to dynamically create, modify &  manage Barcode images in POTX Presentations inside C#, ASP.NET & other .NET apps."
...
steps:
    enable: true
    block:
    - title_left: "Add Barcodes inside POTX Presentations"
      content_left: |
       The below C# .NET code shows how users can dynamically create Barcode images using different supported symbologies and insert them inside a Microsoft PowerPoint POTX presentation slides.
      
      title_right: "Insert Barcodes in POTX File via .NET"
      content_right: |
