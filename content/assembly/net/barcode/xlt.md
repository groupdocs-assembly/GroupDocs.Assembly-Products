...
############################# Header ############################
title: "Barcodes Creation & Management in XLT Spreadsheet via .NET API"
description: "Using GroupDocs.Assembly .NET API software developers can dynamically create &  manage Barcode images in Excel XLT Spreadsheet documents inside C#, ASP.NET apps."
...
steps:
    enable: true
    block:
    - title_left: "Barcodes Generation in XLT Spreadsheets via .NET"
      content_left: |
       GroupDocs.Assembly .NET provides complete support for adding and managing Barcodes inside XLT  spreadsheet. The following C# .NET code example demonstrates how to generate and insert barcode images inside a Microsoft Excel Spreadsheet document. 
