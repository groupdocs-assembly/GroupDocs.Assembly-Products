...
draft: false
path: "ja/assembly/net/barcode/pdf/"
otherformats: HTML XPS TIFF MHTML TXT XAML EPUB SVG PS PCL XML OXPS MD EML EMLX MSG 

############################# Head ############################
head_title: ".NETを介してPDF ドキュメントと電子メールでバーコード画像を作成および追加する"
...
############################# Header ############################
title: ".NETAPIを介してPDF ドキュメントにバーコード画像を生成して挿入する"
description: "GroupDocs.Assembly .NETは、C＃およびVB.NET APIを使用して、動的なバーコードイメージの作成、編集、およびPDFドキュメント内での追加を完全にサポートします。"
...
about:
    enable: true
    title: "PDFドキュメントでバーコード画像の生成を実行する方法は？"
    content: |
...
steps:
    enable: true
    block:
    - title_left: ".NETを介したPDF ドキュメントでのバーコードの生成"
      content_left: |
       GroupDocs.Assembly .NETは、PDF ドキュメント内のバーコードの追加と管理を完全にサポートします。 次のC＃.NETコード例は、PDFドキュメント内にバーコードイメージを生成して挿入する方法を示しています。 

      title_right: "PDF でバーコード画像を使用する方法"
      content_right: |
...
title: ".NETAPIを介したPDFドキュメントでのバーコード画像の生成と挿入"
description: "GroupDocs.Assembly .NETは、C＃およびVB.NET APIを使用して、動的なバーコード画像の作成、編集、およびPDFドキュメント内での追加を完全にサポートします。"
...
steps:
    enable: true
    block:
    - title_left: ".NETを介したPDFドキュメントでのバーコード生成"
      content_left: |
       GroupDocs.Assembly .NETは、PDFドキュメント内のバーコードの追加と管理を完全にサポートします。次のC＃.NETコード例は、PDFドキュメント内にバーコード画像を生成して挿入する方法を示しています。 

      title_right: "PDFでバーコード画像を使用する方法"
      content_right: |
        * [DocumentAssembler](https://apireference.groupdocs.com/assembly/net/groupdocs.assembly/documentassembler)のインスタンスを作成します 
...
<<<<<<< HEAD
    - title_left: ".NET経由でPDF にバーコード画像の解像度を設定"
      content_left: |
       GroupDocs.Assembly .NETは、PDF ドキュメント内のバーコードの追加と管理を完全にサポートします。 数行のコードで簡単にバーコード解像度を設定できます。 次のコードを使用すると、ユーザーは水平および垂直の解像度を300DPIに設定できます。

      title_right: "PDF の強化されたバーコード解像度"
      content_right: |
        * [DocumentAssembler](https://apireference.groupdocs.com/assembly/net/groupdocs.assembly/documentassembler) のインスタンスを作成します 
=======
    - title_left: ".NETを介してPDFでバーコード画像の解像度を設定する"
      content_left: |
       GroupDocs.Assembly .NETは、PDFドキュメント内のバーコードの追加と管理を完全にサポートします。数行のコードでバーコードの解像度を簡単に設定できます。次のコードを使用すると、ユーザーは水平および垂直の解像度を300DPIに設定できます。 

      title_right: "PDFで強化されたバーコード解像度"
      content_right: |
        * [DocumentAssembler](https://apireference.groupdocs.com/assembly/net/groupdocs.assembly/documentassembler)のインスタンスを作成します 
>>>>>>> a412dc18b5488251d42f98ec3007ac8bde559922
