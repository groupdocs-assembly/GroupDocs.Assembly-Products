...
############################# Header ############################
title: "通过 .NET API 在 ODS  电子表格中创建和管理条码"
description: "使用 GroupDocs.Assembly .NET API 软件开发人员可以在 C#、ASP.NET 应用程序内的 Excel ODS  电子表格文档中动态创建和管理条码图像。"
...
steps:
    enable: true
    block:
    - title_left: "通过 .NET 在 ODS  电子表格中生成条码"
      content_left: |
       GroupDocs.Assembly .NET 完全支持在 ODS  电子表格中添加和管理条码。 以下 C# .NET 代码示例演示了如何在 Microsoft Excel 电子表格文档中生成和插入条形码图像。 

      title_right: "如何在 ODS 中使用条形码图像"
      content_right: |
