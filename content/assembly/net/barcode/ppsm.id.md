...
description: " GroupDocs.Assembly memungkinkan pemrogram .NET untuk membuat, memodifikasi & mengelola gambar Barcode secara dinamis di PPSM Presentations di dalam C#, ASP.NET & aplikasi .NET lainnya."
...
steps:
    enable: true
    block:
    - title_left: "Tambahkan Barcode di dalam PPSM Presentations"
      content_left: |
       Kode C# .NET di bawah ini menunjukkan bagaimana pengguna dapat secara dinamis membuat gambar Barcode menggunakan simbologi yang didukung berbeda dan memasukkannya ke dalam slide presentasi Microsoft PowerPoint PPSM.
      
      title_right: "Masukkan Barcode dalam File PPSM melalui .NET"
      content_right: |
