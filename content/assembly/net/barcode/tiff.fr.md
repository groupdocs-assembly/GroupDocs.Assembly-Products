...
draft: false
path: "fr/assembly/net/barcode/tiff/"
...
############################# Header ############################
title: "Générer et insérer des images de codes-barres dans les documents TIFF via l'API .NET"
description: "GroupDocs.Assembly .NET fournit une prise en charge complète de la création, de l'édition et de l'ajout dynamiques d'images de codes-barres dans les documents TIFF à l'aide de l'API C# et VB.NET."
...
steps:
    enable: true
    block:
    - title_left: "Génération de codes-barres dans les documents TIFF via .NET"
      content_left: |
       GroupDocs.Assembly .NET fournit une prise en charge complète pour l'ajout et la gestion des codes-barres dans les documents TIFF. L'exemple de code C# .NET suivant montre comment générer et insérer des images de code-barres dans un document TIFF. 

      title_right: "Comment utiliser les images de codes-barres dans TIFF"
      content_right: |
