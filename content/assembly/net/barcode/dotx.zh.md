...
############################# Header ############################
title: "通过 .NET 在 Word BARCODE 文档中创建和使用条形码图像"
description: "使用 GroupDocs.Assembly .NET API 程序员可以在 C#、ASP.NET 和其他 .NET 应用程序内的 Word BARCODE 文档中动态创建和管理条码图像。"
...
steps:
    enable: true
    block:
    - title_left: "如何在 BARCODE 文档中创建条形码"
      content_left: |
       以下 .NET 代码示例显示了用户只需几行代码即可轻松地在自己的 Microsoft Word BARCODE 文档中动态生成和添加条形码图像。  

      title_right: "通过 .NET 在 BARCODE 文件中使用条形码图像"
      content_right: |
