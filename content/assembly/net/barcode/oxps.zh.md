...
draft: false
path: "zh/assembly/net/barcode/oxps/"
...
############################# Header ############################
title: "通过 .NET API 在 OXPS 文档中生成和插入条形码图像"
description: "GroupDocs.Assembly .NET 完全支持使用 C# 和 VB.NET API 在 OXPS 文档中创建、编辑和添加动态条码图像。"
...
steps:
    enable: true
    block:
    - title_left: "通过 .NET 在 OXPS 文档中生成条码"
      content_left: |
       GroupDocs.Assembly .NET 完全支持在 OXPS 文档中添加和管理条码。 以下 C# .NET 代码示例演示了如何在 BARCODE 文档中生成和插入条形码图像。 

      title_right: "如何在 OXPS 中使用条形码图像"
      content_right: |
    ...
    - title_left: "通过 .NET 在 OXPS 中设置条码图像分辨率"
      content_left: |
       GroupDocs.Assembly .NET 完全支持在 OXPS 文档中添加和管理条码。 您只需几行代码即可轻松设置条形码分辨率。 以下代码允许用户将水平和垂直分辨率设置为 300 DPI。
