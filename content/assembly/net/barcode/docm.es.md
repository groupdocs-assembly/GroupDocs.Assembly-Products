...
draft: false
path: "es/assembly/net/barcode/docm/"
...
############################# Header ############################
title: "Cree y use imágenes de código de barras en documentos de Word DOCM a través de .NET"
description: "Usando GroupDocs.Assembly .NET API, los programadores pueden crear y administrar dinámicamente imágenes de códigos de barras en documentos Word DOCM dentro de C#, ASP.NET y otras aplicaciones .NET."
...
steps:
    enable: true
    block:
    - title_left: "Cómo crear códigos de barras en documentos DOCM"
      content_left: |
       El siguiente ejemplo de código .NET muestra con qué facilidad los usuarios pueden generar y agregar dinámicamente imágenes de código de barras dentro de sus propios documentos de Microsoft Word DOCM con solo un par de líneas de código.

      title_right: "Use imágenes de código de barras en DOCM File a través de .NET"
      content_right: |
