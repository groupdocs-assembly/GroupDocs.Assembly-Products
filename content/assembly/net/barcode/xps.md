...
############################# Header ############################
title: "Generate & Insert Barcode Images in XPS Documents via .NET API"
description: "GroupDocs.Assembly .NET provides complete support for dynamic Barcode image creation, editing and addition inside XPS documents using C# & VB.NET API."
...
steps:
    ...
    - title_left: "Barcodes Generation in XPS Documents via .NET"
      ...
      title_right: "How to Use Barcode Images in XPS"
      content_right: |
    ...
    - title_left: "Set Barcode Image Resolution in XPS via .NET"
      ...
      title_right: "Enhanced Barcode Resolution in XPS"
      content_right: |
        * Create an instance of [DocumentAssembler ](https://apireference.groupdocs.com/assembly/net/groupdocs.assembly/documentassembler) 
