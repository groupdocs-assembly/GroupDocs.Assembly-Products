...
############################# Head ############################
head_title: "Crea tabelle in documenti PPTX con C#"
...
############################# Header ############################
title: "Genera tabelle di dati in documenti PPTX utilizzando la nostra API .NET" 
description: "GroupDocs.Assembly for .NET consente di riempire dinamicamente tabelle in documenti PPTX con dati provenienti da varie fonti."
...
steps:
    enable: true
    title: "Come popolare una tabella in un documento PPTX"
    content: |
      [GroupDocs.Assembly](/assembly/net/) ti consente di popolare dinamicamente tabelle in modelli per formati come PPTX. Inserisci dati provenienti da varie fonti nelle tue tabelle.
      
      1. Crea un modello PPTX con segnaposto per la tabella.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Come popolare dinamicamente una tabella di dati"
      content: |
        Questo esempio dimostra come riempire una tabella in un documento PPTX utilizzando dati dinamici.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
