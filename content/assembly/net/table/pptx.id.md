...
############################# Head ############################
head_title: "Buat tabel dalam dokumen PPTX dengan C#"
...
############################# Header ############################
title: "Hasilkan tabel data dalam dokumen PPTX menggunakan API .NET kami" 
description: "GroupDocs.Assembly for .NET memungkinkan pengisian tabel dalam dokumen PPTX secara dinamis dengan data dari berbagai sumber."
...
steps:
    enable: true
    title: "Cara mengisi tabel dalam dokumen PPTX"
    content: |
      [GroupDocs.Assembly](/assembly/net/) memungkinkan Anda mengisi tabel dalam template untuk format seperti PPTX. Masukkan data dari berbagai sumber ke dalam tabel Anda.
      
      1. Buat template PPTX dengan placeholder tabel.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Cara mengisi tabel data secara dinamis"
      content: |
        Contoh ini menunjukkan cara mengisi tabel dalam dokumen PPTX menggunakan data dinamis.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
