...
############################# Head ############################
head_title: "Crie tabelas em documentos PPTX com C#"
...
############################# Header ############################
title: "Gere tabelas de dados em documentos PPTX usando nossa API .NET" 
description: "GroupDocs.Assembly for .NET facilita o preenchimento dinâmico de tabelas em documentos PPTX com dados de várias fontes."
...
steps:
    enable: true
    title: "Como preencher uma tabela em um documento PPTX"
    content: |
      [GroupDocs.Assembly](/assembly/net/) permite que você preencha dinamicamente tabelas em modelos para formatos como PPTX. Insira dados de várias fontes nas suas tabelas.
      
      1. Crie um modelo PPTX com espaços reservados para a tabela.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Como preencher dinamicamente uma tabela de dados"
      content: |
        Este exemplo demonstra como preencher uma tabela em um documento PPTX usando dados dinâmicos.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
