...
############################# Head ############################
head_title: "Créer des tables dans des documents XLSX avec C#"
...
############################# Header ############################
title: "Générer des tables de données dans des documents XLSX en utilisant notre API .NET" 
description: "GroupDocs.Assembly for .NET permet de remplir dynamiquement des tables dans des documents XLSX avec des données de diverses sources."
...
steps:
    enable: true
    title: "Comment peupler une table dans un document XLSX"
    content: |
      [GroupDocs.Assembly](/assembly/net/) vous permet de peupler dynamiquement des tables dans des modèles pour des formats comme XLSX. Insérez des données provenant de diverses sources dans vos tables.
