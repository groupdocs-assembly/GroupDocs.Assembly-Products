...
############################# Head ############################
head_title: "Sisipkan satu dokumen ke dalam dokumen PPTX menggunakan Java"
head_description: "Gabungkan file PPTX dengan Java. GroupDocs.Assembly menyederhanakan proses penggabungan dokumen hanya dalam beberapa baris kode."

############################# Header ############################
title: "Sisipkan konten ke dalam file PPTX dengan mudah" 
description: "Gunakan GroupDocs.Assembly for Java untuk menyisipkan satu dokumen PPTX ke dalam yang lain secara mulus. Dapatkan hasil yang tepat dengan alat yang fleksibel dan dapat diandalkan."
...
steps:
    enable: true
    title: "Langkah-langkah untuk menyisipkan dokumen ke dalam file PPTX"
    content: |
      [GroupDocs.Assembly](/assembly/java/) memudahkan penyisipan satu dokumen PPTX ke dalam yang lain yang sederhana dan dapat disesuaikan.
      
      1. Siapkan templat PPTX dengan placeholder untuk konten yang disisipkan.
