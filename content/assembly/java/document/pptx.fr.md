...
############################# Head ############################
head_title: "Insérer un document dans un autre en PPTX à l'aide de Java"
head_description: "Combinez des fichiers PPTX avec Java. GroupDocs.Assembly simplifie le processus de fusion de documents en seulement quelques lignes de code."

############################# Header ############################
title: "Intégrez du contenu dans des fichiers PPTX sans effort" 
description: "Utilisez GroupDocs.Assembly for Java pour insérer facilement un document PPTX dans un autre. Obtenez des résultats précis avec des outils flexibles et fiables."
...
steps:
    enable: true
    title: "Étapes pour insérer un document dans un fichier PPTX"
    content: |
      [GroupDocs.Assembly](/assembly/java/) rend l'insertion d'un document PPTX dans un autre simple et personnalisable.
      
      1. Préparez un modèle PPTX avec des espaces réservés pour le contenu intégré.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Comment insérer programmatique un image dans un document"
      content: |
        Cet exemple montre comment intégrer une image dans un fichier PPTX en utilisant GroupDocs.Assembly.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
