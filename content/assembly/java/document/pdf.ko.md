...
############################# Head ############################
head_title: "Java를 사용하여 PDF에 문서 삽입하기"
head_description: "Java를 사용하여 PDF 파일을 결합하세요. GroupDocs.Assembly는 몇 줄의 코드로 문서를 병합하는 과정을 간소화합니다."

############################# Header ############################
title: "PDF 파일에 콘텐츠를 손쉽게 삽입하세요" 
description: "GroupDocs.Assembly for Java를 사용하여 한 PDF 문서를 다른 문서에 원활하게 삽입할 수 있습니다. 유연하고 신뢰할 수 있는 도구로 정확한 결과를 얻으세요."
...
steps:
    enable: true
    title: "PDF 파일에 문서를 삽입하는 단계"
    content: |
      [GroupDocs.Assembly](/assembly/java/)를 사용하면 하나의 PDF 문서를 다른 문서에 간단하고 유연하게 삽입할 수 있습니다.
      
      1. 삽입할 콘텐츠에 대한 자리 표시자가 있는 템플릿을 만드세요 (PDF 템플릿은 지원되지 않습니다).
      2. 템플릿의 파일 경로를 지정하세요.
      3. 삽입할 문서의 파일 경로를 제공하세요.
      4. 병합된 콘텐츠와 함께 최종 파일을 PDF 형식으로 저장하세요.
