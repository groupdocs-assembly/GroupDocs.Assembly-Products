...
############################# Head ############################
head_title: "使用Java将一个文档插入另一个XLSX中"
head_description: "使用Java轻松组合XLSX文件。GroupDocs.Assembly简化了仅需几行代码即可合并文档的过程。"

############################# Header ############################
title: "轻松将内容嵌入XLSX文件" 
description: "使用GroupDocs.Assembly for Java无缝地将一个XLSX文档插入到另一个文档中。借助灵活和可靠的工具获得准确的结果。"
...
steps:
    enable: true
    title: "将文档插入XLSX文件的步骤"
    content: |
      [GroupDocs.Assembly](/assembly/java/)使将一个XLSX文档嵌入到另一个文档中变得简单且可定制。
      
      1. 准备一个具有嵌入内容占位符的XLSX模板。
      2. 指定模板的文件路径。
      3. 提供要嵌入的文档的文件路径。
      4. 保存带有合并内容的输出文件。
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "如何以编程方式将图像插入文档中"
      content: |
        此示例展示了如何使用GroupDocs.Assembly将图像嵌入到XLSX文件中。
      code:
        title: "Java"
        content: |
          ```java {style=abap}
