...
############################# Head ############################
head_title: "Inserte un documento en otro en DOCX usando Java"
head_description: "Combina archivos DOCX con Java. GroupDocs.Assembly simplifica el proceso de fusión de documentos en solo unas pocas líneas de código."

############################# Header ############################
title: "Incorpore contenido en archivos DOCX sin esfuerzo" 
description: "Utilice GroupDocs.Assembly for Java para insertar sin problemas un documento DOCX en otro. Obtenga resultados precisos con herramientas flexibles y confiables."
...
steps:
    enable: true
    title: "Pasos para insertar un documento en un archivo DOCX"
    content: |
      [GroupDocs.Assembly](/assembly/java/) hace que la incorporación de un documento DOCX en otro sea simple y personalizable.
      
      1. Prepare una plantilla DOCX con marcadores de posición para el contenido embebido.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Cómo insertar programáticamente una imagen en un documento"
      content: |
        Este ejemplo muestra cómo incrustar una imagen en un archivo DOCX utilizando GroupDocs.Assembly.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
