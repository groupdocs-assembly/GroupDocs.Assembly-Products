...
draft: false
path: "ko/assembly/java/document/mhtml"
...
############################# Head ############################
head_title: "Java API: MHTML 파일 형식에 외부 문서 콘텐츠 추가"
...
steps:
    ...
    - title_left: "Java를 통해 Word 문서에 외부 파일 내용 추가"
      ...
      title_right: "문서 내용을 MHTML 파일에 삽입하는 방법"
      content_right: |
        * 소스 문서 템플릿 설정
        * 대상 문서 보고서 설정
    ...
    - title_left: "Java를 통해 이메일 메시지에 외부 파일 내용 추가"
      ...
      title_right: "파일 내용을 MHTML 문서에 추가하는 방법"
      content_right: |
        * 소스 문서 템플릿 설정
        * 대상 문서 보고서 설정
        * [DocumentAssembler](https://apireference.groupdocs.com/assembly/java/com.groupdocs.assembly/DocumentAssembler) 클래스의 인스턴스 생성
