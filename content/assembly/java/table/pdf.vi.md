...
############################# Head ############################
head_title: "Thêm bảng vào tài liệu PDF bằng Java"
...
############################# Header ############################
title: "Dễ dàng điền bảng vào tệp PDF với API Java của chúng tôi" 
description: "GroupDocs.Assembly for Java đơn giản hóa quy trình điền bảng trong tài liệu PDF bằng dữ liệu từ nhiều nguồn khác nhau."
...
steps:
    enable: true
    title: "Các bước để chèn dữ liệu vào bảng PDF"
    content: |
      [GroupDocs.Assembly](/assembly/java/) giúp bạn điền các mẫu bảng cho PDF và các định dạng khác. Sử dụng dữ liệu động từ các nguồn của bạn để tạo bảng một cách hiệu quả.
      
      1. Thiết kế một mẫu với vị trí giữ chỗ cho bảng (các mẫu PDF hiện tại không được hỗ trợ).
      2. Kéo dữ liệu từ bất kỳ nguồn đầu vào nào được hỗ trợ.
      3. Lọc hoặc xử lý trước dữ liệu để phù hợp với nhu cầu của bạn.
      4. Lưu tài liệu với bảng đã được điền dưới dạng tệp PDF.
    ...
    code:
      ...
      content: |
        ...
        // Các mẫu PDF chưa được hỗ trợ vào lúc này.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Tạo bảng điền dữ liệu một cách động"
      content: |
        Ví dụ này cho thấy cách điền một bảng trong tài liệu PDF sử dụng dữ liệu đầu vào động.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
