...
############################# Head ############################
head_title: "Aggiungi tabelle ai documenti PPTX utilizzando Java"
...
############################# Header ############################
title: "Popola facilmente le tabelle nei file PPTX con la nostra API Java" 
description: "GroupDocs.Assembly for Java semplifica il processo di riempimento delle tabelle nei documenti PPTX con dati provenienti da vari input."
...
steps:
    enable: true
    title: "Passaggi per inserire i dati in una tabella PPTX"
    content: |
      [GroupDocs.Assembly](/assembly/java/) ti aiuta a popolare i modelli di tabella per PPTX e altri formati. Utilizza dati dinamici dalle tue fonti per creare tabelle senza difficoltà.
      
      1. Imposta un modello PPTX con segnaposto per le righe e le colonne della tabella.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Crea dinamicamente una tabella riempita di dati"
      content: |
        Questo esempio mostra come popolare una tabella in un documento PPTX utilizzando dati di input dinamici.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
