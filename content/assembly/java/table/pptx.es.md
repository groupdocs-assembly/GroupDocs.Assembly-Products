...
############################# Head ############################
head_title: "Agrega tablas a documentos PPTX utilizando Java"
...
############################# Header ############################
title: "Rellena tablas en archivos PPTX con nuestra API Java" 
description: "GroupDocs.Assembly for Java simplifica el proceso de llenar tablas en documentos PPTX con datos de diversas entradas."
...
steps:
    enable: true
    title: "Pasos para insertar datos en una tabla PPTX"
    content: |
      [GroupDocs.Assembly](/assembly/java/) te ayuda a llenar plantillas de tablas para PPTX y otros formatos. Usa datos dinámicos de tus fuentes para crear tablas de manera eficiente.
      
      1. Configura una plantilla PPTX con marcadores de posición para filas y columnas de tabla.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Crea una tabla llena de datos de manera dinámica"
      content: |
        Este ejemplo muestra cómo llenar una tabla en un documento PPTX utilizando datos de entrada dinámicos.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
