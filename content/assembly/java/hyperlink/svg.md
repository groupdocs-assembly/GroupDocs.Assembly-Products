...
draft: false
path: "assembly/java/hyperlink/svg"
...
############################# Head ############################
head_title: "Add Hyperlinks to Office SVG Documents & Reports via Java API"
...
steps:
    ...
    - title_left: "Insert Hyperlinks to Word Processing Documents via Java"
      ...
      title_right: "Insert Hyperlinks in SVG Document via Java"
      content_right: |
    ...
    - title_left: "Add Hyperlinks in Spreadsheets via Java"
      ...
      title_right: "How to Insert Hyperlinks to SVG File"
      content_right: |
