...
draft: false
path: "ko/assembly/java/hyperlink/pps/"
...
############################# Head ############################
head_title: "Java API를 통해 Office PPS 문서 및 보고서에 하이퍼링크 추가"
...
steps:
    ...
    - title_left: "Java를 통해 워드 프로세싱 문서에 하이퍼링크 삽입"
      ...
      title_right: "Java를 통해 PPS 문서에 하이퍼링크 삽입"
      content_right: |
        * 소스 및 대상 문서 설정
    ...
    - title_left: "Java를 통해 스프레드시트에 하이퍼링크 추가"
      ...
      title_right: "PPS 파일에 하이퍼링크를 삽입하는 방법"
      content_right: |
