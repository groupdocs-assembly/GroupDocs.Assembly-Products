...
draft: false
path: "es/assembly/java/hyperlink/tiff/"
...
############################# Head ############################
head_title: "Agregar hipervínculos a Office TIFF Documentos e informes a través de la API de Java"
...
steps:
    ...
    - title_left: "Insertar hipervínculos a documentos de procesamiento de texto a través de Java"
      ...
      title_right: "Insertar hipervínculos en el documento TIFF a través de Java"
      content_right: |
    ...
    - title_left: "Agregar hipervínculos en hojas de cálculo a través de Java"
      ...
      title_right: "Cómo insertar hipervínculos al archivo TIFF"
      content_right: |
