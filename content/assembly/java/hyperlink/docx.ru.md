...
draft: false
path: "ru/assembly/java/hyperlink/docx/"
...
############################# Head ############################
head_title: "Добавление гиперссылок в документы и отчеты Office DOCX через Java API"
...
steps:
    ...
    - title_left: "Вставка гиперссылок на документы обработки текста через Java"
      ...
      title_right: "Вставка гиперссылок в документ DOCX с помощью Java"
      content_right: |
    ...
    - title_left: "Добавить гиперссылки в электронные таблицы через Java"
      ...
      title_right: "Как вставить гиперссылки в файл DOCX"
      content_right: |
