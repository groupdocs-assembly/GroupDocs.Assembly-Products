...
draft: false
path: "ja/assembly/java/hyperlink/ods/"
...
############################# Head ############################
head_title: "JavaAPIを介してOfficeODS ドキュメントとレポートにハイパーリンクを追加する"
...
steps:
    ...
    - title_left: "Javaを介してWord処理ドキュメントへのハイパーリンクを挿入する"
      ...
      title_right: "Java経由でODSドキュメントにハイパーリンクを挿入する"
      content_right: |
    ...
    - title_left: "Javaを介してスプレッドシートにハイパーリンクを追加する"
      ...
      title_right: "ODSファイルへのハイパーリンクを挿入する方法"
      content_right: |
