...
draft: false
path: "assembly/java/hyperlink/potx"
...
############################# Head ############################
head_title: "Add Hyperlinks to Office POTX Documents & Reports via Java API"
...
steps:
    ...
    - title_left: "Insert Hyperlinks to Word Processing Documents via Java"
      ...
      title_right: "Insert Hyperlinks in POTX Document via Java"
      content_right: |
    ...
    - title_left: "Add Hyperlinks in Spreadsheets via Java"
      ...
      title_right: "How to Insert Hyperlinks to POTX File"
      content_right: |
