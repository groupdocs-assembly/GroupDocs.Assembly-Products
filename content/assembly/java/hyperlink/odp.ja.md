...
draft: false
path: "ja/assembly/java/hyperlink/odp/"
...
############################# Head ############################
head_title: "JavaAPIを介してOfficeODP ドキュメントとレポートにハイパーリンクを追加する"
...
steps:
    ...
    - title_left: "Javaを介してWord処理ドキュメントへのハイパーリンクを挿入する"
      ...
      title_right: "Java経由でODPドキュメントにハイパーリンクを挿入する"
      content_right: |
    ...
    - title_left: "Javaを介してスプレッドシートにハイパーリンクを追加する"
      ...
      title_right: "ODPファイルへのハイパーリンクを挿入する方法"
      content_right: |
