...
draft: false
path: "fr/assembly/java/hyperlink/potx/"
...
############################# Head ############################
head_title: "Ajouter des hyperliens aux documents et rapports Office POTX via l'API Java"
...
steps:
    ...
    - title_left: "Insérer des hyperliens vers des documents de traitement de texte via Java"
      ...
      title_right: "Insérer des liens hypertexte dans le document POTX via Java"
      content_right: |
    ...
    - title_left: "Ajouter des hyperliens dans les feuilles de calcul via Java"
      ...
      title_right: "Comment insérer des liens hypertexte dans le fichier POTX"
      content_right: |
