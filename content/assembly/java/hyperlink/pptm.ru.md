...
draft: false
path: "ru/assembly/java/hyperlink/pptm/"
...
############################# Head ############################
head_title: "Добавление гиперссылок в документы и отчеты Office PPTM через Java API"
...
steps:
    ...
    - title_left: "Вставка гиперссылок на документы обработки текста через Java"
      ...
      title_right: "Вставка гиперссылок в документ PPTM с помощью Java"
      content_right: |
    ...
    - title_left: "Добавить гиперссылки в электронные таблицы через Java"
      ...
      title_right: "Как вставить гиперссылки в файл PPTM"
      content_right: |
