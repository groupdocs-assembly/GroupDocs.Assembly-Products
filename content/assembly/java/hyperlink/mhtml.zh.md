...
draft: false
path: "zh/assembly/java/hyperlink/mhtml/"
...
############################# Head ############################
head_title: "通过 Java API 将超链接添加到 Office MHTML 文档和报告"
...
steps:
    ...
    - title_left: "通过 Java 插入到文字处理文档的超链接"
      ...
      title_right: "通过 Java 在 MHTML 文档中插入超链接"
      content_right: |
        * 设置源文档和目标文档
        * 设置 Uri 表达式以及显示文本表达式
