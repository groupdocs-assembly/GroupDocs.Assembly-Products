...
draft: false
path: "assembly/java/hyperlink/odp"
...
############################# Head ############################
head_title: "Add Hyperlinks to Office ODP Documents & Reports via Java API"
...
steps:
    ...
    - title_left: "Insert Hyperlinks to Word Processing Documents via Java"
      ...
      title_right: "Insert Hyperlinks in ODP Document via Java"
      content_right: |
    ...
    - title_left: "Add Hyperlinks in Spreadsheets via Java"
      ...
      title_right: "How to Insert Hyperlinks to ODP File"
      content_right: |
