...
draft: false
path: "ru/assembly/java/hyperlink/emlx/"
...
############################# Head ############################
head_title: "Добавление гиперссылок в документы и отчеты Office EMLX через Java API"
...
steps:
    ...
    - title_left: "Вставка гиперссылок на документы обработки текста через Java"
      ...
      title_right: "Вставка гиперссылок в документ EMLX с помощью Java"
      content_right: |
    ...
    - title_left: "Добавить гиперссылки в электронные таблицы через Java"
      ...
      title_right: "Как вставить гиперссылки в файл EMLX"
      content_right: |
