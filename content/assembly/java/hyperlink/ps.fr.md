...
draft: false
path: "fr/assembly/java/hyperlink/ps/"
...
############################# Head ############################
head_title: "Ajouter des hyperliens aux documents et rapports Office PS via l'API Java"
...
steps:
    ...
    - title_left: "Insérer des hyperliens vers des documents de traitement de texte via Java"
      ...
      title_right: "Insérer des liens hypertexte dans le document PS via Java"
      content_right: |
    ...
    - title_left: "Ajouter des hyperliens dans les feuilles de calcul via Java"
      ...
      title_right: "Comment insérer des liens hypertexte dans le fichier PS"
      content_right: |
