...
############################# Header ############################
title: "Generate Barcode Images in Word RTF Documents via Java API"
description: "GroupDocs.Assembly java API makes it easy for software developers to dynamically create & modify Barcode images inside their Word RTF documents inside Java applications."
...
steps:
    enable: true
    block:
    - title_left: "Barcodes Images Generation in RTF Documents"
      content_left: |
       The following java code example shows dynamic creation and insertion of Barcode images inside Microsoft Word RTF documents. Developers can achieve the task using just a couple of lines of Java code.
