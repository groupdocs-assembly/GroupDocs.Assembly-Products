...
############################# Head ############################
head_title: "Встраивайте штрих-коды в файлы PDF с помощью Java"
...
############################# Header ############################
title: "Генерация штрих-кодов для файлов PDF с помощью нашего API Java" 
description: "GroupDocs.Assembly for Java предоставляет всесторонние инструменты для динамического создания, настройки и встраивания штрих-кодов в файлы PDF."
...
steps:
    enable: true
    title: "Как встроить штрих-код в документ PDF"
    content: |
      [GroupDocs.Assembly](/assembly/java/) позволяет вставлять штрих-коды в популярные форматы, такие как шаблоны PDF. Поддерживает более 60 типов, включая 1D и 2D штрих-коды.
