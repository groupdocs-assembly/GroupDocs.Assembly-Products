...
draft: false
path: "de/assembly/java/barcode/mhtml/"
...
############################# Header ############################
title: "Java-Barcodes-Generator-API – Erstellen Sie 1D- und 2D-Barcodes in MHTML-Dokumenten"
...
steps:
    enable: true
    block:
    - title_left: "Kisten-Barcodes in MHTML-Dokumenten über Java"
      content_left: |
       GroupDocs.Assembly Java enthält vollständige Funktionen zum Einfügen und Bearbeiten von Barcodes in MHTML-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Sie mit nur wenigen Codezeilen Barcodebilder in einem MHTML Dokument erstellen und verwenden. 

      title_right: "Wie füge ich Barcodes in MHTML-Dateien hinzu?"
      content_right: |
