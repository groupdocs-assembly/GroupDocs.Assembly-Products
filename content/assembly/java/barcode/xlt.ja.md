...
draft: false
path: "ja/assembly/java/barcode/xlt/"
...
steps:
    ...
    - title_left: "Javaを介してXLTスプレッドシートにバーコードを作成する"
      content_left: |
<<<<<<< HEAD
       GroupDocs.Assembly Javaは、XLTスプレッドシート内でバーコードを作成および管理するための完全なサポートを提供します。 次のJavaコードは、MicrosoftExcelSpreadsheetドキュメント内にバーコードイメージを作成して挿入する方法を示しています。 
