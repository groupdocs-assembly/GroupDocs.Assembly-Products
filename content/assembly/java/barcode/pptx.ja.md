...
draft: false
path: "ja/assembly/java/barcode/pptx/"
otherformats: PPT PPTM PPS PPSX PPSM POT POTX POTM ODP OTP 

############################# Head ############################
head_title: "JavaAPIを介して PPTX プレゼンテーションでバーコード画像を作成および追加する"
...
############################# Header ############################
title: "JavaAPIを介してPPTX プレゼンテーションでバーコード画像を生成および編集する"
description: "GroupDocs.Assembly Java APIを使用すると、プログラマーは、JavaおよびJSPアプリ内のPPTX PowerPointプレゼンテーションでバーコード画像を生成、編集、および挿入できます。"
...
head_title: "JavaAPIを介してPPTXプレゼンテーションでバーコード画像を作成および追加する"
head_description: "GroupDocs.Assembly Java APIは、PowerPointプレゼンテーション（PPT、PPTX、PPTM、PPS、PPSX、PPSM、POT、およびODP）ファイル内でのバーコード画像の作成と追加をサポートします."

title: "JavaAPIを介してPPTXプレゼンテーションでバーコード画像を生成および編集する"
description: "GroupDocs.Assembly Java APIを使用すると、プログラマーはJavaおよびJSPアプリ内のPPTX PowerPointプレゼンテーションでバーコード画像を生成、編集、および挿入できます。"
...
steps:
    enable: true
    block:
    - title_left: "PPTXプレゼンテーションでのバーコードの生成"
      content_left: |
<<<<<<< HEAD
       以下のJavaコードは、開発者がサポートされているさまざまなシンボルを使用してバーコードイメージを生成し、それらをMicrosoft PowerPoint PPTX プレゼンテーションスライドに非常に少ない労力とコストで追加する方法を説明しています。

      title_right: "Javaを介してPPTXファイルにバーコードを追加する"
      content_right: |
...
=======
       以下のJavaコードは、開発者がサポートされているさまざまなシンボルを使用してバーコードイメージを生成し、非常に少ない労力とコストでMicrosoftPowerPointPPTXプレゼンテーションスライドに追加する方法を説明しています。 
