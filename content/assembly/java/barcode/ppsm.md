...
############################# Head ############################
head_title: "Create & Add Barcode Images in PPSM Presentations via Java API"
...
############################# Header ############################
title: "Generate & Edit Barcode images in PPSM Presentations via Java API"
description: "GroupDocs.Assembly Java API allows programmers to generate, edit & insert Barcode images in PPSM PowerPoint Presentations inside Java & JSP apps."
...
steps:
    enable: true
    block:
    - title_left: "Barcodes Generation in PPSM Presentations"
      content_left: |
       The below Java code explains how developers can generate Barcode images using different supported symbologies and add them into Microsoft PowerPoint PPSM presentation slides with very littel effort and cost. 

      title_right: "Add Barcodes in PPSM File via Java"
      content_right: |
