...
############################# Head ############################
head_title: "Create & Add Barcode Images in PPTM Presentations via Java API"
...
############################# Header ############################
title: "Generate & Edit Barcode images in PPTM Presentations via Java API"
description: "GroupDocs.Assembly Java API allows programmers to generate, edit & insert Barcode images in PPTM PowerPoint Presentations inside Java & JSP apps."
...
steps:
    enable: true
    block:
    - title_left: "Barcodes Generation in PPTM Presentations"
      content_left: |
       The below Java code explains how developers can generate Barcode images using different supported symbologies and add them into Microsoft PowerPoint PPTM presentation slides with very littel effort and cost. 

      title_right: "Add Barcodes in PPTM File via Java"
      content_right: |
