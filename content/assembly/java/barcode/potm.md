...
############################# Head ############################
head_title: "Create & Add Barcode Images in POTM Presentations via Java API"
...
############################# Header ############################
title: "Generate & Edit Barcode images in POTM Presentations via Java API"
description: "GroupDocs.Assembly Java API allows programmers to generate, edit & insert Barcode images in POTM PowerPoint Presentations inside Java & JSP apps."
...
steps:
    enable: true
    block:
    - title_left: "Barcodes Generation in POTM Presentations"
      content_left: |
       The below Java code explains how developers can generate Barcode images using different supported symbologies and add them into Microsoft PowerPoint POTM presentation slides with very littel effort and cost. 

      title_right: "Add Barcodes in POTM File via Java"
      content_right: |
