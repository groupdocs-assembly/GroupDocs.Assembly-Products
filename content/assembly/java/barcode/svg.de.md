...
draft: false
path: "de/assembly/java/barcode/svg/"
...
############################# Header ############################
title: "Java-Barcodes-Generator-API – Erstellen Sie 1D- und 2D-Barcodes in SVG-Dokumenten"
...
steps:
    enable: true
    block:
    - title_left: "Kisten-Barcodes in SVG-Dokumenten über Java"
      content_left: |
       GroupDocs.Assembly Java enthält vollständige Funktionen zum Einfügen und Bearbeiten von Barcodes in SVG-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Sie mit nur wenigen Codezeilen Barcodebilder in einem SVG Dokument erstellen und verwenden. 

      title_right: "Wie füge ich Barcodes in SVG-Dateien hinzu?"
      content_right: |
