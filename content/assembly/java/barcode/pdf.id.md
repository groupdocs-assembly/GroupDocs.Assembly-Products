...
draft: false
path: "assembly/java/barcode/pdf"
...
head_description: "GroupDocs.Assembly Java API memungkinkan pemrogram untuk membuat & menambahkan Barcode dalam dokumen (PDF, DOC, DOCX, RTF, XLSX, CSV, PPTX) & Email (EML EMLX MSG) pesan."

title: "Java Barcodes Generator API - Buat Barcode 1D & 2D di Dokumen PDF"
...
steps:
    enable: true
    block:
    - title_left: "Peti Barcode dalam PDF Dokumen melalui Java"
      content_left: |
       GroupDocs.Assembly Java telah menyertakan fungsionalitas lengkap untuk menyisipkan dan mengedit Barcode di dalam dokumen PDF. Contoh kode Java berikut menunjukkan cara membuat dan menggunakan gambar kode batang di dalam dokumen PDF hanya dengan beberapa baris kode. 

      title_right: "Bagaimana Cara Menambahkan Barcode di File PDF?"
      content_right: |
