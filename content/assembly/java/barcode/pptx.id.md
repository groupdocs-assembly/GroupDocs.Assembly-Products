...
############################# Head ############################
head_title: "Sisipkan barcode dalam file PPTX dengan Java"
...
############################# Header ############################
title: "Hasilkan barcode untuk file PPTX dengan API Java kami" 
description: "GroupDocs.Assembly for Java menyediakan alat yang komprehensif untuk membuat, menyesuaikan, dan menyisipkan barcode secara dinamis ke dalam file PPTX."
...
steps:
    enable: true
    title: "Cara menyisipkan barcode dalam dokumen PPTX"
    content: |
      [GroupDocs.Assembly](/assembly/java/) memungkinkan Anda menyisipkan barcode ke dalam format populer seperti template PPTX. Mendukung lebih dari 60 jenis, termasuk barcode 1D dan 2D.
      
      1. Siapkan template PPTX dengan penanda barcode.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Cara membuat barcode secara dinamis"
      content: |
        Contoh ini menunjukkan bagaimana cara menghasilkan dan menambahkan barcode ke dokumen PPTX secara dinamis.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
