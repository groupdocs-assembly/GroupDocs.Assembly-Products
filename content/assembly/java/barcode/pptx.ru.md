...
############################# Head ############################
head_title: "Встраивайте штрих-коды в файлы PPTX с помощью Java"
...
############################# Header ############################
title: "Генерация штрих-кодов для файлов PPTX с помощью нашего API Java" 
description: "GroupDocs.Assembly for Java предоставляет всесторонние инструменты для динамического создания, настройки и встраивания штрих-кодов в файлы PPTX."
...
steps:
    enable: true
    title: "Как встроить штрих-код в документ PPTX"
    content: |
      [GroupDocs.Assembly](/assembly/java/) позволяет вставлять штрих-коды в популярные форматы, такие как шаблоны PPTX. Поддерживает более 60 типов, включая 1D и 2D штрих-коды.
      
      1. Настройте шаблон PPTX с маркерами штрих-кодов.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Как динамически создать штрих-код"
      content: |
        Этот пример показывает, как динамически генерировать и добавлять штрих-код в документ PPTX.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
