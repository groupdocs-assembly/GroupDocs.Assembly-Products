...
draft: false
path: "zh/assembly/java/barcode/xlsx/"
...
steps:
    enable: true
    block:
    - title_left: "通过 Java 在 XLSX 电子表格中创建条形码"
      content_left: |
       GroupDocs.Assembly Java 完全支持在 XLSX 电子表格中创建和管理条形码。 以下 Java 代码演示了如何在 Microsoft Excel 电子表格文档中创建和插入条形码图像。

      title_right: "如何在 XLSX 文件中添加条形码图像"
      content_right: |
