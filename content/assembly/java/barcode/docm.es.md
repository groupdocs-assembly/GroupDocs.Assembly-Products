...
draft: false
path: "zh/assembly/java/barcode/docm/"
...
############################# Header ############################
title: "Genere imágenes de código de barras en documentos de Word DOCM a través de la API de Java"
description: "GroupDocs.Assembly java API facilita a los desarrolladores de software la creación y modificación dinámica de imágenes de códigos de barras dentro de sus documentos Word DOCM dentro de aplicaciones Java."
...
steps:
    enable: true
    block:
    - title_left: "Generación de Imágenes de Códigos de Barras en DOCM Documentos"
      content_left: |
       El siguiente ejemplo de código Java muestra la creación dinámica y la inserción de imágenes de código de barras dentro de documentos de Microsoft Word DOCM. Los desarrolladores pueden lograr la tarea usando solo un par de líneas de código Java.

      title_right: "Agregue códigos de barras en el archivo DOCM a través de Java"
      content_right: |
