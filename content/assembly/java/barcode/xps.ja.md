...
draft: false
path: "ja/assembly/java/barcode/xps/"
...
############################# Header ############################
title: "Java Barcodes Generator API XPS ドキュメントで1Dおよび2Dバーコードを作成します"
...
steps:
    enable: true
    block:
    - title_left: "Javaを介してXPS ドキュメントでバーコードを作成する"
      content_left: |
      ...
      title_right: "XPS ファイルにバーコードを追加する方法は？"
      content_right: |
