...
############################# Head ############################
head_title: "Incrustar códigos de barras en archivos PPTX con Java"
...
############################# Header ############################
title: "Generar códigos de barras para archivos PPTX con nuestra API Java" 
description: "GroupDocs.Assembly for Java proporciona herramientas exhaustivas para crear, personalizar e incrustar códigos de barras dinámicamente en archivos PPTX."
...
steps:
    enable: true
    title: "Cómo incrustar un código de barras en un documento PPTX"
    content: |
      [GroupDocs.Assembly](/assembly/java/) le permite insertar códigos de barras en formatos populares como las plantillas PPTX. Soporta más de 60 tipos, incluidos códigos de barras 1D y 2D.
      
      1. Configurar una plantilla PPTX con marcadores de código de barras.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Cómo crear un código de barras dinámicamente"
      content: |
        Este ejemplo muestra cómo generar y añadir dinámicamente un código de barras a un documento PPTX.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
