...
title: "Hasilkan Gambar Barcode di Dokumen Word DOCX melalui Java API"
description: "GroupDocs.Assembly java API memudahkan pengembang perangkat lunak untuk membuat & memodifikasi gambar Barcode secara dinamis di dalam dokumen Word DOCX mereka di dalam aplikasi Java."
...
steps:
    enable: true
    block:
    - title_left: "Pembuatan Gambar Barcode dalam DOCX Dokumen"
      content_left: |
       Contoh kode java berikut menunjukkan pembuatan dinamis dan penyisipan gambar Barcode di dalam dokumen Microsoft Word DOCX. Pengembang dapat mencapai tugas hanya dengan menggunakan beberapa baris kode Java.

      title_right: "Tambahkan Barcode di DOCX File melalui Java"
      content_right: |
