...
draft: false
path: "de/assembly/java/barcode/ps/"
...
############################# Header ############################
title: "Java-Barcodes-Generator-API – Erstellen Sie 1D- und 2D-Barcodes in PS-Dokumenten"
...
steps:
    enable: true
    block:
    - title_left: "Kisten-Barcodes in PS-Dokumenten über Java"
      content_left: |
       GroupDocs.Assembly Java enthält vollständige Funktionen zum Einfügen und Bearbeiten von Barcodes in PS-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Sie mit nur wenigen Codezeilen Barcodebilder in einem PS Dokument erstellen und verwenden. 

      title_right: "Wie füge ich Barcodes in PS-Dateien hinzu?"
      content_right: |
