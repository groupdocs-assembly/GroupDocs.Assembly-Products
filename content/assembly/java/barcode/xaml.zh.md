...
draft: false
path: "ru/assembly/java/barcode/xaml/"
...
############################# Header ############################
title: "Java Barcodes Generator API - 在 XAML 文档中创建一维和二维条码"
...
steps:
    enable: true
    block:
    - title_left: "通过 Java 在 XAML 文档中创建条码"
      content_left: |
       GroupDocs.Assembly Java 包含用于在 XAML 文档中插入和编辑条形码的完整功能。 以下 Java 代码示例演示了如何通过几行代码在 XAML 文档中创建和使用条形码图像。 

      title_right: "如何在 XAML 文件中添加条形码？"
      content_right: |
