...
title: "Java Barcodes Generator API - Buat Barcode 1D & 2D di Dokumen HTML"
...
steps:
    enable: true
    block:
    - title_left: "Peti Barcode dalam HTML Dokumen melalui Java"
      content_left: |
       GroupDocs.Assembly Java telah menyertakan fungsionalitas lengkap untuk menyisipkan dan mengedit Barcode di dalam dokumen HTML. Contoh kode Java berikut menunjukkan cara membuat dan menggunakan gambar kode batang di dalam dokumen HTML hanya dengan beberapa baris kode. 

      title_right: "Bagaimana Cara Menambahkan Barcode di File HTML?"
      content_right: |
