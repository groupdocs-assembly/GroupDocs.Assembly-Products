...
title: "Java Barcodes Generator API - Buat Barcode 1D & 2D di Dokumen XPS"
...
steps:
    enable: true
    block:
    - title_left: "Peti Barcode dalam XPS Dokumen melalui Java"
      content_left: |
       GroupDocs.Assembly Java telah menyertakan fungsionalitas lengkap untuk menyisipkan dan mengedit Barcode di dalam dokumen XPS. Contoh kode Java berikut menunjukkan cara membuat dan menggunakan gambar kode batang di dalam dokumen XPS hanya dengan beberapa baris kode. 

      title_right: "Bagaimana Cara Menambahkan Barcode di File XPS?"
      content_right: |
