...
draft: false
path: "assembly/java/barcode/msg"
...
title: "Java Barcodes Generator API - Buat Barcode 1D & 2D di Dokumen MSG"
...
steps:
    enable: true
    block:
    - title_left: "Peti Barcode dalam MSG Dokumen melalui Java"
      content_left: |
       GroupDocs.Assembly Java telah menyertakan fungsionalitas lengkap untuk menyisipkan dan mengedit Barcode di dalam dokumen MSG. Contoh kode Java berikut menunjukkan cara membuat dan menggunakan gambar kode batang di dalam dokumen MSG hanya dengan beberapa baris kode. 

      title_right: "Bagaimana Cara Menambahkan Barcode di File MSG?"
      content_right: |
