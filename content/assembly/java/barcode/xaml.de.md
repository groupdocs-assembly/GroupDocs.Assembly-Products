...
draft: false
path: "de/assembly/java/barcode/xaml/"
...
############################# Header ############################
title: "Java-Barcodes-Generator-API – Erstellen Sie 1D- und 2D-Barcodes in XAML-Dokumenten"
...
steps:
    enable: true
    block:
    - title_left: "Kisten-Barcodes in XAML-Dokumenten über Java"
      content_left: |
       GroupDocs.Assembly Java enthält vollständige Funktionen zum Einfügen und Bearbeiten von Barcodes in XAML-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Sie mit nur wenigen Codezeilen Barcodebilder in einem XAML Dokument erstellen und verwenden. 

      title_right: "Wie füge ich Barcodes in XAML-Dateien hinzu?"
      content_right: |
