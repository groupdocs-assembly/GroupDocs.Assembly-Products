...
title: "Java Barcodes Generator API - Buat Barcode 1D & 2D di Dokumen TXT"
...
steps:
    enable: true
    block:
    - title_left: "Peti Barcode dalam TXT Dokumen melalui Java"
      content_left: |
       GroupDocs.Assembly Java telah menyertakan fungsionalitas lengkap untuk menyisipkan dan mengedit Barcode di dalam dokumen TXT. Contoh kode Java berikut menunjukkan cara membuat dan menggunakan gambar kode batang di dalam dokumen TXT hanya dengan beberapa baris kode. 

      title_right: "Bagaimana Cara Menambahkan Barcode di File TXT?"
      content_right: |
