...
draft: false
path: "de/assembly/java/barcode/xps/"
...
############################# Header ############################
title: "Java-Barcodes-Generator-API – Erstellen Sie 1D- und 2D-Barcodes in XPS-Dokumenten"
...
steps:
    enable: true
    block:
    - title_left: "Kisten-Barcodes in XPS-Dokumenten über Java"
      content_left: |
       GroupDocs.Assembly Java enthält vollständige Funktionen zum Einfügen und Bearbeiten von Barcodes in XPS-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Sie mit nur wenigen Codezeilen Barcodebilder in einem XPS Dokument erstellen und verwenden. 

      title_right: "Wie füge ich Barcodes in XPS-Dateien hinzu?"
      content_right: |
