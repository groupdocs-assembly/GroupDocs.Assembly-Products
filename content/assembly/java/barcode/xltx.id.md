...
draft: false
path: "assembly/java/barcode/xltx"
...
steps:
    enable: true
    block:
    - title_left: "Buat Barcode di XLTX Spreadsheet melalui Java"
      content_left: |
       GroupDocs.Assembly Java menyediakan dukungan lengkap untuk membuat dan mengelola Barcode di dalam spreadsheet XLTX. Kode Java berikut menunjukkan cara membuat dan menyisipkan gambar kode batang di dalam dokumen Microsoft Excel Spreadsheet. 

      title_right: "Cara Menambahkan Gambar Barcode di File XLTX"
      content_right: |
