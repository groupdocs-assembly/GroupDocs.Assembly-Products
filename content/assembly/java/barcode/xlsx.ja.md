...
############################# Head ############################
head_title: "Javaを使用してXLSXファイルにバーコードを埋め込む"
head_description: "GroupDocs.Assembly for Java APIを使用すると、文書や電子メールにリアルタイムでバーコード画像を作成して挿入することが簡単になります。"

############################# Header ############################
title: "私たちのJava APIを使ってXLSXファイルのバーコードを生成する" 
description: "GroupDocs.Assembly for Javaは、XLSXファイルにバーコードを動的に作成、カスタマイズ、埋め込むための包括的なツールを提供します。"
...
steps:
    enable: true
    title: "XLSX文書にバーコードを埋め込む方法"
    content: |
      [GroupDocs.Assembly](/assembly/java/)を使用すると、XLSXテンプレートのような人気フォーマットにバーコードを挿入できます。1Dおよび2Dバーコードを含む60種類以上をサポートしています。
      
      1. XLSXテンプレートをバーコードマーカーで設定します。
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "動的にバーコードを作成する方法"
      content: |
        この例では、XLSX文書にバーコードを動的に生成および追加する方法を示します。
      code:
        title: "Java"
        content: |
          ```java {style=abap}
