...
draft: false
path: "fr/assembly/java/barcode/dot/"
...
############################# Header ############################
title: "Générer des images de codes à barres dans des documents Word DOT via l'API Java"
description: "L'API Java GroupDocs.Assembly permet aux développeurs de logiciels de créer et de modifier dynamiquement des images de codes-barres dans leurs documents Word DOT dans des applications Java."
...
steps:
    enable: true
    block:
    - title_left: "Génération d'images de codes-barres dans DOT Documents"
      content_left: |
       L'exemple de code Java suivant montre la création et l'insertion dynamiques d'images de codes à barres dans des documents Microsoft Word DOT . Les développeurs peuvent accomplir la tâche en utilisant seulement quelques lignes de code Java.
