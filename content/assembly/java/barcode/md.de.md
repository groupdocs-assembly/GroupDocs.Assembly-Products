...
draft: false
path: "de/assembly/java/barcode/md/"
...
############################# Header ############################
title: "Java-Barcodes-Generator-API – Erstellen Sie 1D- und 2D-Barcodes in MD-Dokumenten"
...
steps:
    enable: true
    block:
    - title_left: "Kisten-Barcodes in MD-Dokumenten über Java"
      content_left: |
       GroupDocs.Assembly Java enthält vollständige Funktionen zum Einfügen und Bearbeiten von Barcodes in MD-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Sie mit nur wenigen Codezeilen Barcodebilder in einem MD Dokument erstellen und verwenden. 

      title_right: "Wie füge ich Barcodes in MD-Dateien hinzu?"
      content_right: |
