...
############################# Head ############################
head_title: "Intégrez des codes-barres dans des fichiers XLSX avec Java"
...
############################# Header ############################
title: "Générez des codes-barres pour des fichiers XLSX avec notre API Java" 
description: "GroupDocs.Assembly for Java offre des outils complets pour créer, personnaliser et intégrer des codes-barres de manière dynamique dans des fichiers XLSX."
...
steps:
    enable: true
    title: "Comment intégrer un code-barres dans un document XLSX"
    content: |
      [GroupDocs.Assembly](/assembly/java/) vous permet d'insérer des codes-barres dans des formats populaires tels que des modèles XLSX. Prend en charge plus de 60 types, y compris des codes-barres 1D et 2D.
      
      1. Configurez un modèle XLSX avec des marqueurs de code-barres.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Comment créer un code-barres dynamiquement"
      content: |
        Cet exemple montre comment générer et ajouter dynamiquement un code-barres à un document XLSX.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
