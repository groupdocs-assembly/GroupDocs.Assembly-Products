...
draft: false
path: "de/assembly/java/barcode/emlx/"
...
############################# Header ############################
title: "Java-Barcodes-Generator-API – Erstellen Sie 1D- und 2D-Barcodes in EMLX-Dokumenten"
...
steps:
    enable: true
    block:
    - title_left: "Kisten-Barcodes in EMLX-Dokumenten über Java"
      content_left: |
       GroupDocs.Assembly Java enthält vollständige Funktionen zum Einfügen und Bearbeiten von Barcodes in EMLX-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Sie mit nur wenigen Codezeilen Barcodebilder in einem EMLX Dokument erstellen und verwenden. 

      title_right: "Wie füge ich Barcodes in EMLX-Dateien hinzu?"
      content_right: |
