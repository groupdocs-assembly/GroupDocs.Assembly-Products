...
title: "Java Barcodes Generator API - Buat Barcode 1D & 2D di Dokumen OXPS"
...
steps:
    enable: true
    block:
    - title_left: "Peti Barcode dalam OXPS Dokumen melalui Java"
      content_left: |
       GroupDocs.Assembly Java telah menyertakan fungsionalitas lengkap untuk menyisipkan dan mengedit Barcode di dalam dokumen OXPS. Contoh kode Java berikut menunjukkan cara membuat dan menggunakan gambar kode batang di dalam dokumen OXPS hanya dengan beberapa baris kode. 

      title_right: "Bagaimana Cara Menambahkan Barcode di File OXPS?"
      content_right: |
