...
############################# Head ############################
head_title: "Embed barcodes in DOCX files with Java"
...
steps:
    enable: true
    title: "How to embed a barcode in a DOCX document"
    content: |
      [GroupDocs.Assembly](/assembly/java/) lets you insert barcodes into popular formats like DOCX templates. Supports over 60 types, including 1D and 2D barcodes.
      
      1. Set up a DOCX template with barcode markers.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "How to create a barcode dynamically"
      content: |
        This example shows how to dynamically generate and add a barcode to a DOCX document.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
