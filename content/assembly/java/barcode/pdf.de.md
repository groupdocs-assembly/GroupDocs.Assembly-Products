...
draft: false
path: "de/assembly/java/barcode/pdf/"
...
############################# Header ############################
title: "Java-Barcodes-Generator-API – Erstellen Sie 1D- und 2D-Barcodes in PDF-Dokumenten"
...
steps:
    enable: true
    block:
    - title_left: "Kisten-Barcodes in PDF-Dokumenten über Java"
      content_left: |
       GroupDocs.Assembly Java enthält vollständige Funktionen zum Einfügen und Bearbeiten von Barcodes in PDF-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Sie mit nur wenigen Codezeilen Barcodebilder in einem PDF Dokument erstellen und verwenden. 

      title_right: "Wie füge ich Barcodes in PDF-Dateien hinzu?"
      content_right: |
