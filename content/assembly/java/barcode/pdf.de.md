...
############################# Head ############################
head_title: "Barcodes in PDF-Dateien mit Java einbetten"
...
############################# Header ############################
title: "Generieren Sie Barcodes für PDF-Dateien mit unserer Java-API" 
description: "GroupDocs.Assembly for Java bietet umfassende Werkzeuge zur dynamischen Erstellung, Anpassung und Einbettung von Barcodes in PDF-Dateien."
...
steps:
    enable: true
    title: "So betten Sie einen Barcode in ein PDF-Dokument ein"
    content: |
      [GroupDocs.Assembly](/assembly/java/) ermöglicht es Ihnen, Barcodes in gängigen Formaten wie PDF-Vorlagen einzufügen. Unterstützt über 60 Typen, einschließlich 1D- und 2D-Barcodes.
      
      1. Bereiten Sie eine Vorlage mit Platzhaltern für Barcodes vor (PDF-Vorlagen werden derzeit nicht unterstützt).
      2. Holen Sie Daten aus einer unterstützten Quelle.
      3. Passen Sie die Barcode-Einstellungen wie Größe und Auflösung an.
      4. Speichern Sie das Dokument mit dem hinzugefügten Barcode als PDF-Datei.
    ...
    code:
      ...
      content: |
        ...
        // Speichern Sie das Dokument mit dem hinzugefügten Barcode als PDF-Datei.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Wie man einen Barcode dynamisch erstellt"
      content: |
        Dieses Beispiel zeigt, wie man dynamisch einen Barcode zu einem PDF-Dokument generiert und hinzufügt.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
