...
draft: false
path: "fr/assembly/java/barcode/xlsb/"
...
steps:
    enable: true
    block:
    - title_left: "Créer des codes-barres dans XLSB feuilles de calcul via Java"
      content_left: |
       GroupDocs.Assembly Java fournit une prise en charge complète pour la création et la gestion de codes-barres dans la feuille de calcul XLSB. Le code Java suivant montre comment créer et insérer des images de codes à barres dans un document de feuille de calcul Microsoft Excel. 

      title_right: "Comment ajouter des images de codes-barres dans le fichier XLSB"
      content_right: |
