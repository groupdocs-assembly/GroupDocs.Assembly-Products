...
draft: false
path: "de/assembly/java/barcode/epub/"
...
############################# Header ############################
title: "Java-Barcodes-Generator-API – Erstellen Sie 1D- und 2D-Barcodes in EPUB-Dokumenten"
...
steps:
    enable: true
    block:
    - title_left: "Kisten-Barcodes in EPUB-Dokumenten über Java"
      content_left: |
       GroupDocs.Assembly Java enthält vollständige Funktionen zum Einfügen und Bearbeiten von Barcodes in EPUB-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Sie mit nur wenigen Codezeilen Barcodebilder in einem EPUB Dokument erstellen und verwenden. 

      title_right: "Wie füge ich Barcodes in EPUB-Dateien hinzu?"
      content_right: |
