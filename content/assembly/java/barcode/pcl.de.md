...
draft: false
path: "de/assembly/java/barcode/pcl/"
...
############################# Header ############################
title: "Java-Barcodes-Generator-API – Erstellen Sie 1D- und 2D-Barcodes in PCL-Dokumenten"
...
steps:
    enable: true
    block:
    - title_left: "Kisten-Barcodes in PCL-Dokumenten über Java"
      content_left: |
       GroupDocs.Assembly Java enthält vollständige Funktionen zum Einfügen und Bearbeiten von Barcodes in PCL-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Sie mit nur wenigen Codezeilen Barcodebilder in einem PCL Dokument erstellen und verwenden. 

      title_right: "Wie füge ich Barcodes in PCL-Dateien hinzu?"
      content_right: |
