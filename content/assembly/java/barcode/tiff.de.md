...
draft: false
path: "de/assembly/java/barcode/tiff/"
...
############################# Header ############################
title: "Java-Barcodes-Generator-API – Erstellen Sie 1D- und 2D-Barcodes in TIFF-Dokumenten"
...
steps:
    enable: true
    block:
    - title_left: "Kisten-Barcodes in TIFF-Dokumenten über Java"
      content_left: |
       GroupDocs.Assembly Java enthält vollständige Funktionen zum Einfügen und Bearbeiten von Barcodes in TIFF-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Sie mit nur wenigen Codezeilen Barcodebilder in einem TIFF Dokument erstellen und verwenden. 

      title_right: "Wie füge ich Barcodes in TIFF-Dateien hinzu?"
      content_right: |
