...
draft: false
path: "ja/assembly/java/barcode/otp/"
otherformats: PPT PPTX PPTM PPS PPSX PPSM POT POTX POTM ODP 

############################# Head ############################
head_title: "JavaAPIを介して OTP プレゼンテーションでバーコード画像を作成および追加する"
...
############################# Header ############################
title: "JavaAPIを介してOTP プレゼンテーションでバーコード画像を生成および編集する"
description: "GroupDocs.Assembly Java APIを使用すると、プログラマーは、JavaおよびJSPアプリ内のOTP PowerPointプレゼンテーションでバーコード画像を生成、編集、および挿入できます。"
...
head_title: "JavaAPIを介してOTPプレゼンテーションでバーコード画像を作成および追加する"
head_description: "GroupDocs.Assembly Java APIは、PowerPointプレゼンテーション（PPT、PPTX、PPTM、PPS、PPSX、PPSM、POT、およびODP）ファイル内でのバーコード画像の作成と追加をサポートします."

title: "JavaAPIを介してOTPプレゼンテーションでバーコード画像を生成および編集する"
description: "GroupDocs.Assembly Java APIを使用すると、プログラマーはJavaおよびJSPアプリ内のOTP PowerPointプレゼンテーションでバーコード画像を生成、編集、および挿入できます。"
...
steps:
    enable: true
    block:
    - title_left: "OTPプレゼンテーションでのバーコードの生成"
      content_left: |
<<<<<<< HEAD
       以下のJavaコードは、開発者がサポートされているさまざまなシンボルを使用してバーコードイメージを生成し、それらをMicrosoft PowerPoint OTP プレゼンテーションスライドに非常に少ない労力とコストで追加する方法を説明しています。

      title_right: "Javaを介してOTPファイルにバーコードを追加する"
      content_right: |
...
=======
       以下のJavaコードは、開発者がサポートされているさまざまなシンボルを使用してバーコードイメージを生成し、非常に少ない労力とコストでMicrosoftPowerPointOTPプレゼンテーションスライドに追加する方法を説明しています。 
