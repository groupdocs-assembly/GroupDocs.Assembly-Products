...
############################# Header ############################
title: "Java Barcodes Generator API - Create 1D & 2D Barcodes  in HTML Documents"
...
steps:
    enable: true
    block:
    - title_left: "Crate Barcodes in HTML Documents via Java"
      content_left: |
       GroupDocs.Assembly Java has included complete functionality for inserting and editing Barcodes inside HTML documents. The following Java code example demonstrates how to create and use barcode images inside a HTML document with just a couple of lines of code. 

      title_right: "How to Add Barcodes in HTML Files?"
      content_right: |
