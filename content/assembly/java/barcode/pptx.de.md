...
draft: false
path: "de/assembly/java/barcode/pptx/"
otherformats: PPT PPTM PPS PPSX PPSM POT POTX POTM ODP OTP 

############################# Head ############################
head_title: "Erstellen und Hinzufügen von Barcode-Bildern in PPTX-Präsentationen über die Java-API"
...
############################# Header ############################
title: "Generieren und bearbeiten Sie Barcode-Bilder in PPTX-Präsentationen über die Java-API"
description: "GroupDocs.Assembly Java API ermöglicht Programmierern das Generieren, Bearbeiten und Einfügen von Barcode-Bildern in PPTX PowerPoint-Präsentationen innerhalb von Java- und JSP-Apps."
...
steps:
    enable: true
    block:
    - title_left: "Barcode-Generierung in PPTX-Präsentationen"
      content_left: |
       Der folgende Java-Code erklärt, wie Entwickler Barcode-Bilder mit verschiedenen unterstützten Symbologien generieren und sie mit sehr geringem Aufwand und geringen Kosten in Microsoft PowerPoint PPTX-Präsentationsfolien einfügen können.

      title_right: "Fügen Sie Barcodes in der PPTX-Datei über Java hinzu"
      content_right: |
