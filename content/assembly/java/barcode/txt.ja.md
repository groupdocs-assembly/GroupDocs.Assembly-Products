...
draft: false
path: "ja/assembly/java/barcode/txt/"
...
############################# Header ############################
title: "Java Barcodes Generator API TXT ドキュメントで1Dおよび2Dバーコードを作成します"
...
steps:
    enable: true
    block:
    - title_left: "Javaを介してTXT ドキュメントでバーコードを作成する"
      content_left: |
      ...
      title_right: "TXT ファイルにバーコードを追加する方法は？"
      content_right: |
