...
draft: false
path: "de/assembly/java/barcode/eml/"
...
############################# Header ############################
title: "Java-Barcodes-Generator-API – Erstellen Sie 1D- und 2D-Barcodes in EML-Dokumenten"
...
steps:
    enable: true
    block:
    - title_left: "Kisten-Barcodes in EML-Dokumenten über Java"
      content_left: |
       GroupDocs.Assembly Java enthält vollständige Funktionen zum Einfügen und Bearbeiten von Barcodes in EML-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Sie mit nur wenigen Codezeilen Barcodebilder in einem EML Dokument erstellen und verwenden. 

      title_right: "Wie füge ich Barcodes in EML-Dateien hinzu?"
      content_right: |
