...
title: "Java Barcodes Generator API - Buat Barcode 1D & 2D di Dokumen PS"
...
steps:
    enable: true
    block:
    - title_left: "Peti Barcode dalam PS Dokumen melalui Java"
      content_left: |
       GroupDocs.Assembly Java telah menyertakan fungsionalitas lengkap untuk menyisipkan dan mengedit Barcode di dalam dokumen PS. Contoh kode Java berikut menunjukkan cara membuat dan menggunakan gambar kode batang di dalam dokumen PS hanya dengan beberapa baris kode. 

      title_right: "Bagaimana Cara Menambahkan Barcode di File PS?"
      content_right: |
