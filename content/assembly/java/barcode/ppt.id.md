...
head_title: "Buat & Tambahkan Gambar Barcode di Presentasi PPT melalui Java API"
...
title: "Hasilkan & Edit gambar Barcode di PPT Presentations melalui Java API"
description: "GroupDocs.Assembly Java API memungkinkan pemrogram untuk menghasilkan, mengedit & menyisipkan gambar Barcode di PPT PowerPoint Presentations di dalam aplikasi Java & JSP."
...
steps:
    enable: true
    block:
    - title_left: "Pembuatan Barcode dalam PPT Presentasi"
      content_left: |
       Kode Java di bawah ini menjelaskan bagaimana pengembang dapat menghasilkan gambar Barcode menggunakan berbagai simbol yang didukung dan menambahkannya ke dalam slide presentasi Microsoft PowerPoint PPT dengan sedikit usaha dan biaya. 

      title_right: "Tambahkan Barcode di PPT File melalui Java"
      content_right: |
