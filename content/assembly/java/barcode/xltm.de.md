...
draft: false
path: "de/assembly/java/barcode/xltm/"
...
steps:
    enable: true
    block:
    - title_left: "Erstellen Sie Barcodes in XLTM Spreadsheets über Java"
      content_left: |
       GroupDocs.Assembly Java bietet vollständige Unterstützung für das Erstellen und Verwalten von Barcodes in der Tabelle XLTM. Der folgende Java-Code zeigt, wie Barcode-Bilder erstellt und in ein Microsoft Excel-Tabellendokument eingefügt werden.

      title_right: "So fügen Sie Barcode-Bilder in der Datei XLTM hinzu"
      content_right: |
