...
draft: false
path: "es/assembly/java/barcode//msg/"
...
############################# Header ############################
title: "Java Barcodes Generator API: cree códigos de barras 1D y 2D en documentos MSG"
...
steps:
    enable: true
    block:
    - title_left: "Cree códigos de barras en MSG documentos a través de Java"
      content_left: |
       GroupDocs.Assembly Java ha incluido una funcionalidad completa para insertar y editar códigos de barras dentro de documentos MSG. El siguiente ejemplo de código Java demuestra cómo crear y usar imágenes de código de barras dentro de un documento MSG con solo un par de líneas de código. 

      title_right: "¿Cómo agregar códigos de barras en archivos MSG?"
      content_right: |
