...
############################# Header ############################
title: "Generate Barcode Images in Word DOCX Documents via Java API"
description: "GroupDocs.Assembly java API makes it easy for software developers to dynamically create & modify Barcode images inside their Word DOCX documents inside Java applications."
...
steps:
    enable: true
    block:
    - title_left: "Barcodes Images Generation in DOCX Documents"
      content_left: |
       The following java code example shows dynamic creation and insertion of Barcode images inside Microsoft Word DOCX documents. Developers can achieve the task using just a couple of lines of Java code.
