...
draft: false
path: "ko/assembly/java/barcode/emlx/"
...
############################# Header ############################
title: "Java Barcodes Generator API - EMLX 문서에서 1D 및 2D 바코드 생성"
...
steps:
    enable: true
    block:
    - title_left: "Java를 통해 EMLX 문서에 바코드 생성"
      content_left: |
       GroupDocs.Assembly Java에는 EMLX 문서 내부에 바코드를 삽입하고 편집하기 위한 완전한 기능이 포함되어 있습니다. 다음 Java 코드 예제는 몇 줄의 코드로 EMLX 문서 내에서 바코드 이미지를 만들고 사용하는 방법을 보여줍니다.

      title_right: "EMLX 파일에 바코드를 추가하는 방법은 무엇입니까?"
      content_right: |
