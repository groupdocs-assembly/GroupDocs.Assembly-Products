...
############################# Header ############################
title: "Java Barcodes Generator API - Create 1D & 2D Barcodes  in TIFF Documents"
...
steps:
    enable: true
    block:
    - title_left: "Crate Barcodes in TIFF Documents via Java"
      content_left: |
       GroupDocs.Assembly Java has included complete functionality for inserting and editing Barcodes inside TIFF documents. The following Java code example demonstrates how to create and use barcode images inside a TIFF document with just a couple of lines of code. 

      title_right: "How to Add Barcodes in TIFF Files?"
      content_right: |
