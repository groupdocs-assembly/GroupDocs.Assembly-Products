...
title: "Hasilkan Gambar Barcode di Dokumen Word RTF melalui Java API"
description: "GroupDocs.Assembly java API memudahkan pengembang perangkat lunak untuk membuat & memodifikasi gambar Barcode secara dinamis di dalam dokumen Word RTF mereka di dalam aplikasi Java."
...
steps:
    enable: true
    block:
    - title_left: "Pembuatan Gambar Barcode dalam RTF Dokumen"
      content_left: |
       Contoh kode java berikut menunjukkan pembuatan dinamis dan penyisipan gambar Barcode di dalam dokumen Microsoft Word RTF. Pengembang dapat mencapai tugas hanya dengan menggunakan beberapa baris kode Java.

      title_right: "Tambahkan Barcode di RTF File melalui Java"
      content_right: |
