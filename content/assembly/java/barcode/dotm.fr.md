...
draft: false
path: "fr/assembly/java/barcode/dotm/"
...
############################# Header ############################
title: "Générer des images de codes à barres dans des documents Word DOTM via l'API Java"
description: "L'API Java GroupDocs.Assembly permet aux développeurs de logiciels de créer et de modifier dynamiquement des images de codes-barres dans leurs documents Word DOTM dans des applications Java."
...
steps:
    enable: true
    block:
    - title_left: "Génération d'images de codes-barres dans DOTM Documents"
      content_left: |
       L'exemple de code Java suivant montre la création et l'insertion dynamiques d'images de codes à barres dans des documents Microsoft Word DOTM . Les développeurs peuvent accomplir la tâche en utilisant seulement quelques lignes de code Java.

      title_right: "Add Barcodes in DOTM File via Java"
      content_right: |
