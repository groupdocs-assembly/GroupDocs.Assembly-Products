...
############################# Head ############################
head_title: "Crea listas en documentos PPTX utilizando Java"
head_description: "Diseña e incrusta dinámicamente listas en tus plantillas PPTX con la API de GroupDocs.Assembly for Java."

############################# Header ############################
title: "Añade listas dinámicas a archivos PPTX con nuestra API de Java" 
description: "GroupDocs.Assembly for Java proporciona herramientas flexibles para generar e insertar listas ricas en datos directamente en documentos PPTX."
...
steps:
    enable: true
    title: "Cómo añadir una lista basada en datos a un documento PPTX"
    content: |
      [GroupDocs.Assembly](/assembly/java/) te permite insertar rápidamente listas ricas en datos en las plantillas PPTX. Personaliza y organiza el contenido sin esfuerzo.
      
      1. Crea una plantilla PPTX y marca los lugares reservados para la lista.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Cómo crear una lista programáticamente"
      content: |
        Este ejemplo muestra cómo añadir dinámicamente una lista a un archivo PPTX utilizando GroupDocs.Assembly.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
