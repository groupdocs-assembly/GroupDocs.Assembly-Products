...
############################# Head ############################
head_title: "Создавайте списки в документах PDF с использованием Java"
head_description: "Разработайте и встроите динамические списки в ваши шаблоны PDF с помощью API GroupDocs.Assembly for Java."

############################# Header ############################
title: "Добавьте динамические списки в файлы PDF с нашим API Java" 
description: "GroupDocs.Assembly for Java предоставляет гибкие инструменты для создания и вставки насыщенных данными списков прямо в документы PDF."
...
steps:
    enable: true
    title: "Как добавить список, основанный на данных, в документ PDF"
    content: |
      [GroupDocs.Assembly](/assembly/java/) позволяет вам быстро вставлять насыщенные данными списки в шаблоны PDF. Настраивайте и организовывайте содержимое без труда.
