...
############################# Head ############################
head_title: "Créer des listes dans des documents DOCX en utilisant Java"
head_description: "Concevez et intégrez facilement des listes dynamiques dans vos modèles DOCX avec l'API GroupDocs.Assembly for Java."

############################# Header ############################
title: "Ajoutez des listes dynamiques aux fichiers DOCX avec notre API Java" 
description: "GroupDocs.Assembly for Java fournit des outils flexibles pour générer et insérer des listes riches en données directement dans des documents DOCX."
...
steps:
    enable: true
    title: "Comment ajouter une liste basée sur des données à un document DOCX"
    content: |
      [GroupDocs.Assembly](/assembly/java/) vous permet d'insérer rapidement des listes riches en données dans des modèles DOCX. Personnalisez et organisez le contenu sans difficulté.
      
      1. Créez un modèle DOCX et marquez les emplacements des espaces réservés pour la liste.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Comment créer une liste par programmation"
      content: |
        Cet exemple montre comment ajouter dynamiquement une liste dans un fichier DOCX en utilisant GroupDocs.Assembly.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
