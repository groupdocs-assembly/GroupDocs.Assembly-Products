...
############################# Head ############################
head_title: "Java를 사용하여 XLSX 문서에 차트 생성하기"
head_description: "GroupDocs.Assembly for Java API는 개발자가 문서에 동적 차트나 그래프를 라이브 데이터로 원활하게 생성하고 삽입할 수 있도록 합니다."

############################# Header ############################
title: "Java API로 XLSX 문서에 차트 추가하기" 
description: "GroupDocs.Assembly for Java은 실시간 데이터를 활용하여 XLSX 문서에 차트를 통합하는 과정을 간소화합니다."
...
steps:
    enable: true
    title: "XLSX 문서에 차트를 삽입하는 단계"
    content: |
      [GroupDocs.Assembly](/assembly/java/)은 XLSX 템플릿에 차트를 삽입하는 과정을 간소화합니다. 바, 파이 및 선 그래프 등 다양한 차트 스타일 중에서 선택하십시오.
      
      1. XLSX 템플릿을 생성하되 차트를 위한 자리 표시자를 포함합니다.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "프로그래밍적으로 차트를 생성하고 삽입하기"
      content: |
        이 예제에서는 차트를 XLSX 문서에 프로그램matically 생성하고 삽입하는 방법을 보여줍니다.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
