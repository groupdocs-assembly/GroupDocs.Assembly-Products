...
############################# Head ############################
head_title: "Diagramme in PPTX-Dokumenten mit Java generieren"
...
############################# Header ############################
title: "Diagramme zu PPTX-Dokumenten mit Java API hinzufügen" 
description: "GroupDocs.Assembly for Java vereinfacht den Prozess der Einbettung von Diagrammen in PPTX-Dokumenten, indem es Echtzeitdaten nutzt."
...
steps:
    enable: true
    title: "Schritte zur Einbettung eines Diagramms in ein PPTX-Dokument"
    content: |
      [GroupDocs.Assembly](/assembly/java/) vereinfacht den Prozess der Einfügung von Diagrammen in PPTX-Vorlagen. Wählen Sie aus verschiedenen Diagrammtypen, einschließlich Balken-, Kreis- und Liniendiagrammen.
      
      1. Erstellen Sie eine PPTX-Vorlage mit Platzhaltern für das Diagramm.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Diagramme programmgesteuert generieren und einfügen"
      content: |
        Dieses Beispiel zeigt, wie Sie ein Diagramm programmatisch in ein PPTX-Dokument erstellen und einfügen.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
