...
############################# Head ############################
head_title: "Genera grafici in documenti PPTX utilizzando Java"
...
############################# Header ############################
title: "Aggiungi grafici ai documenti PPTX con l'API Java" 
description: "GroupDocs.Assembly for Java semplifica il processo di incorporamento dei grafici nei documenti PPTX sfruttando dati in tempo reale."
...
steps:
    enable: true
    title: "Passaggi per incorporare un grafico in un documento PPTX"
    content: |
      [GroupDocs.Assembly](/assembly/java/) semplifica il processo di inserimento di grafici nei template PPTX. Scegli tra una varietà di stili di grafico, inclusi grafici a barre, a torta e a linee.
      
      1. Crea un template PPTX con segnaposto per il grafico.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Genera e incorpora grafici programmaticamente"
      content: |
        Questo esempio dimostra come creare e incorporare un grafico in un documento PPTX in modo programmatico.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
