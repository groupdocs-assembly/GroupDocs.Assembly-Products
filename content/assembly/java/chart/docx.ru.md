...
############################# Head ############################
head_title: "Генерируйте диаграммы в DOCX документах, используя Java"
...
############################# Header ############################
title: "Добавьте диаграммы в DOCX документы с помощью API Java" 
description: "GroupDocs.Assembly for Java упрощает процесс встраивания диаграмм в DOCX документы, используя данные в реальном времени."
...
steps:
    enable: true
    title: "Шаги для встраивания диаграммы в документ DOCX"
    content: |
      [GroupDocs.Assembly](/assembly/java/) упрощает процесс вставки диаграмм в шаблоны DOCX. Выбирайте из различных стилей диаграмм, включая столбчатые, круговые и линейные.
      
      1. Создайте шаблон DOCX с заполнительными местами для диаграммы.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Программно создавайте и встраивайте диаграммы"
      content: |
        Этот пример демонстрирует, как программно создать и встроить диаграмму в документ DOCX.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
