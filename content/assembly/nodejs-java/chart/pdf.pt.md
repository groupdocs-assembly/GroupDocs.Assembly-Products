...
############################# Head ############################
head_title: "Insira Gráficos em Arquivos PDF com JavaScript"
...
############################# Header ############################
title: "Adicione Gráficos a Arquivos PDF Usando Node.js" 
description: "GroupDocs.Assembly for Node.js via Java simplifica o processo de integração de gráficos em documentos PDF com entrada de dados em tempo real."
...
steps:
    enable: true
    title: "Passos para Adicionar um Gráfico a um Documento PDF"
    content: |
      [GroupDocs.Assembly](/assembly/nodejs-java/) facilita a adição de gráficos a arquivos PDF. Escolha entre tipos de gráficos como gráfico de barras, gráfico de linhas ou gráfico de pizza.
      
      1. Crie um template com espaços reservados para gráficos (templates PDF não são suportados).
    ...
    code:
      ...
      content: |
        ...
        // Nota: Templates PDF não são atualmente suportados.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Gere e Insira Gráficos Dinamicamente"
      content: |
        Este exemplo ilustra como criar e incorporar gráficos em arquivos PDF programaticamente.
      code:
        title: "Java"
        content: |
          ```javascript {style=abap}
