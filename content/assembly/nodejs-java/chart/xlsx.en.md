...
############################# Head ############################
head_title: "Insert Charts in XLSX Files with JavaScript"
...
############################# Header ############################
title: "Easily Add Charts to XLSX Files Using Node.js" 
description: "GroupDocs.Assembly for Node.js via Java streamlines the process of integrating charts into XLSX documents with real-time data input."
...
steps:
    enable: true
    title: "Steps to Add a Chart to a XLSX Document"
    content: |
      [GroupDocs.Assembly](/assembly/nodejs-java/) makes adding charts to XLSX files easy. Choose from chart types like bar, line, or pie charts.
      
      1. Design a XLSX template with placeholders for charts.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Dynamically Generate and Insert Charts"
      content: |
        This example illustrates how to create and embed charts into XLSX files programmatically.
      code:
        title: "Java"
        content: |
          ```javascript {style=abap}
