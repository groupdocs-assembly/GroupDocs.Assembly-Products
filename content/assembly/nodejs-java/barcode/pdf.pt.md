...
############################# Head ############################
head_title: "Adicione Códigos de Barras a Arquivos PDF Usando JavaScript"
...
############################# Header ############################
title: "Crie Códigos de Barras para Arquivos PDF Usando Node.js" 
description: "Com GroupDocs.Assembly for Node.js via Java, você pode gerar, personalizar e incorporar códigos de barras dinamicamente em documentos PDF."
...
steps:
    enable: true
    title: "Passos para Adicionar um Código de Barras em Arquivos PDF"
    content: |
      [GroupDocs.Assembly](/assembly/nodejs-java/) facilita a incorporação de códigos de barras em documentos PDF. Suporta mais de 60 tipos de código de barras, incluindo formatos 1D e 2D.
      
      1. Projete um template com espaços reservados para códigos de barras (templates PDF não são suportados).
      2. Recupere dados de uma fonte compatível.
      3. Defina opções de código de barras, como tamanho e resolução.
      4. Exporte o documento com o código de barras como um arquivo PDF.
    ...
    code:
      ...
      content: |
        ...
        // Nota: Templates PDF atualmente não são suportados.
        ...
        // Exporte o documento com o código de barras como um arquivo PDF.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Exemplo: Gere um Código de Barras Programaticamente"
      content: |
        Este exemplo demonstra como gerar e inserir programaticamente um código de barras em um documento PDF.
      code:
        title: "Java"
        content: |
          ```javascript {style=abap}
