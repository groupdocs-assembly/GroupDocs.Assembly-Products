...
############################# Head ############################
head_title: "Erstellen Sie dynamische Listen in XLSX mit JavaScript"
head_description: "Gestalten und fügen Sie Listen in XLSX-Vorlagen über die GroupDocs.Assembly for Node.js via Java-API ein."

############################# Header ############################
title: "Datengetriebene Listen in XLSX-Dateien mit Node.js einbetten" 
description: "GroupDocs.Assembly for Node.js via Java bietet leistungsstarke Werkzeuge, um flexible, datenbasierte Listen in XLSX-Dokumente einzufügen."
...
steps:
    enable: true
    title: "Schritte zum Einfügen einer Liste in eine XLSX-Datei"
    content: |
      [GroupDocs.Assembly](/assembly/nodejs-java/) vereinfacht das Hinzufügen detaillierter, datengetriebener Listen zu Ihren XLSX-Vorlagen.
      
      1. Erstellen Sie eine XLSX-Vorlage und definieren Sie Platzhalter für die Liste.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Programmatisch eine Liste in ein Dokument erstellen"
      content: |
        Dieses Beispiel zeigt, wie Sie dynamisch eine Liste zu einem XLSX-Dokument mit GroupDocs.Assembly hinzufügen.
      code:
        title: "Java"
        content: |
          ```javascript {style=abap}
