...
############################# Head ############################
head_title: "Combina Documentos en PPTX con JavaScript"
head_description: "Combina archivos PPTX utilizando JavaScript. GroupDocs.Assembly simplifica la fusión de documentos en solo unos pocos pasos."

############################# Header ############################
title: "Combina Contenido en Archivos PPTX de Forma Eficiente" 
description: "Con GroupDocs.Assembly for Node.js via Java, integrar un archivo PPTX en otro es rápido y preciso. Disfruta de herramientas flexibles y confiables para una fusión sin complicaciones."
...
steps:
    ...
    content: |
      [GroupDocs.Assembly](/assembly/nodejs-java/) facilita la inserción de un archivo PPTX en otro con opciones personalizables.
      
      1. Diseña una plantilla PPTX con marcadores de posición para el contenido.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Incrustar una Imagen en un Documento Programáticamente"
      content: |
        Este ejemplo muestra cómo insertar una imagen en un archivo PPTX utilizando GroupDocs.Assembly.
      code:
        title: "Java"
        content: |
          ```javascript {style=abap}
