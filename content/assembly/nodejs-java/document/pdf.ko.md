...
############################# Head ############################
head_title: "JavaScript로 PDF 파일 병합하기"
head_description: "JavaScript를 사용하여 PDF 파일을 간편하게 결합하세요. GroupDocs.Assembly는 문서 병합을 몇 가지 간단한 단계로 효율적으로 처리합니다."

############################# Header ############################
title: "PDF 파일의 내용을 손쉽게 결합하기" 
description: "GroupDocs.Assembly for Node.js via Java을 사용하면 하나의 PDF 파일을 다른 파일에 신속하고 정확하게 통합할 수 있습니다. 매끄러운 병합을 위한 유연하고 신뢰할 수 있는 도구를 즐기세요."
...
steps:
    enable: true
    title: "PDF 파일에 문서 병합하기"
    content: |
      [GroupDocs.Assembly](/assembly/nodejs-java/)은 커스터마이즈 가능한 옵션으로 하나의 PDF 파일을 다른 파일에 삽입하는 과정을 간소화합니다.
      
      1. 삽입된 콘텐츠를 위한 플레이스홀더가 있는 템플릿을 디자인합니다 (PDF 템플릿은 지원되지 않습니다).
      2. 템플릿에 대한 파일 경로를 설정합니다.
      3. 병합할 문서의 파일 경로를 제공합니다.
      4. 병합된 콘텐츠를 포함하여 최종 문서를 PDF 파일로 저장합니다.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "프로그램을 통해 문서에 이미지 삽입하기"
      content: |
        이 예제는 GroupDocs.Assembly를 사용하여 PDF 파일에 이미지를 삽입하는 방법을 보여줍니다.
      code:
        title: "Java"
        content: |
          ```javascript {style=abap}
