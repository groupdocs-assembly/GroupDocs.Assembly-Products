...
############################# Head ############################
head_title: "Merge Documents in PPTX with JavaScript"
head_description: "Easily combine PPTX files using JavaScript. GroupDocs.Assembly streamlines document merging in just a few simple steps."

############################# Header ############################
title: "Effortlessly Combine Content in PPTX Files" 
description: "With GroupDocs.Assembly for Node.js via Java, integrating one PPTX file into another is quick and precise. Enjoy flexible, reliable tools for seamless merging."
...
steps:
    ...
    content: |
      [GroupDocs.Assembly](/assembly/nodejs-java/) makes it easy to insert one PPTX file into another with customizable options.
      
      1. Design a PPTX template with placeholders for the content.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Embed an Image into a Document Programmatically"
      content: |
        This example demonstrates how to insert an image into a PPTX file using GroupDocs.Assembly.
      code:
        title: "Java"
        content: |
          ```javascript {style=abap}
