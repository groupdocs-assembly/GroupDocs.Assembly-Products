...
############################# Head ############################
head_title: "Insira Tabelas em Documentos DOCX com JavaScript"
...
############################# Header ############################
title: "Adicione Tabelas a Arquivos DOCX com Node.js" 
description: "Com o GroupDocs.Assembly for Node.js via Java, preencher tabelas em documentos DOCX é direto, utilizando dados de múltiplas fontes."
...
steps:
    enable: true
    title: "Como Adicionar Dados a uma Tabela em DOCX"
    content: |
      [GroupDocs.Assembly](/assembly/nodejs-java/) permite que você preencha rapidamente modelos de tabela para arquivos DOCX usando fontes de dados dinâmicas.
      
      1. Crie um modelo DOCX com espaços reservados para linhas e colunas da tabela.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Como Preencher Programaticamente uma Tabela"
      content: |
        Este exemplo demonstra como preencher uma tabela em um documento DOCX com dados de uma fonte externa.
      code:
        title: "Java"
        content: |
          ```javascript {style=abap}
