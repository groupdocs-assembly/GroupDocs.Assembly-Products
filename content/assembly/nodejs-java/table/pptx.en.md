...
############################# Head ############################
head_title: "Insert Tables into PPTX Documents with JavaScript"
...
############################# Header ############################
title: "Effortlessly Add Tables to PPTX Files with Node.js" 
description: "With GroupDocs.Assembly for Node.js via Java, filling tables in PPTX documents is simple, using data from multiple sources."
...
steps:
    enable: true
    title: "How to Add Data to a Table in PPTX"
    content: |
      [GroupDocs.Assembly](/assembly/nodejs-java/) enables you to quickly populate table templates for PPTX files using dynamic data sources.
      
      1. Create a PPTX template with placeholders for table rows and columns.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "How to Programmatically Populate a Table"
      content: |
        This example demonstrates filling a table in a PPTX document with data from an external source.
      code:
        title: "Java"
        content: |
          ```javascript {style=abap}
